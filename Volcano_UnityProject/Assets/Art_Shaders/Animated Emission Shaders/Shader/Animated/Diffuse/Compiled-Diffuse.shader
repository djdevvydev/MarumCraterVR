Shader "Animated/Diffuse/Diffuse"
{
	Properties 
	{
...
void main ()
{
  ...
  tmpvar_16 = ((Tex2D0_6.wwww * vec4(_Specular)) * _SpecularColor).xyz;
  tmpvar_3 = tmpvar_16;
  highp float tmpvar_17;
  tmpvar_17 = tmpvar_14.x;
  tmpvar_5 = tmpvar_17;
  mediump vec3 tmpvar_18;
  tmpvar_18 = normalize(vec3(0.000000, 0.000000, 1.00000));
  highp vec3 tmpvar_19;
  tmpvar_19 = normalize(xlv_TEXCOORD3);
  mediump vec3 lightDir_20;
  lightDir_20 = xlv_TEXCOORD1;
  mediump vec3 viewDir_21;
  viewDir_21 = tmpvar_19;
  mediump vec4 res_22;
  highp float nh_23;
  mediump float tmpvar_24;
  tmpvar_24 = max (0.000000, dot (tmpvar_18, normalize((lightDir_20 + viewDir_21))));
  nh_23 = tmpvar_24;
  mediump float arg1_25;
  arg1_25 = (tmpvar_4 * 128.000);
  res_22.xyz = (_LightColor0.xyz * max (0.000000, dot (lightDir_20, tmpvar_18)));
  lowp float tmpvar_26;
  tmpvar_26 = dot (_LightColor0.xyz, vec3(0.220000, 0.707000, 0.0710000));
  highp float tmpvar_27;
  tmpvar_27 = (pow (nh_23, arg1_25) * tmpvar_26);
  res_22.w = tmpvar_27;
  mediump vec4 tmpvar_28;
  tmpvar_28 = (res_22 * 2.00000);
  res_22 = tmpvar_28;
  mediump vec4 c_29;
  c_29.xyz = ((tmpvar_2 * tmpvar_28.xyz) + (tmpvar_28.xyz * (tmpvar_28.w * tmpvar_3)));
  c_29.w = tmpvar_5;
  c_1 = c_29;
  mediump vec3 tmpvar_30;
  tmpvar_30 = (c_1.xyz + (tmpvar_2 * xlv_TEXCOORD2));
  c_1.xyz = tmpvar_30;
...
void main ()
{
  ...
  lowp vec4 tmpvar_11;
  tmpvar_11 = texture2D (_Diffuse, tmpvar_10.xy);
  Tex2D0_4 = tmpvar_11;
  highp vec4 tmpvar_12;
  ...
  tmpvar_3 = tmpvar_14;
  lowp vec3 tmpvar_15;
  tmpvar_15 = (2.00000 * texture2D (unity_Lightmap, xlv_TEXCOORD1).xyz);
...
void main ()
{
  ...
  lowp vec3 tmpvar_16;
  tmpvar_16 = ((8.00000 * tmpvar_15.w) * tmpvar_15.xyz);
  mediump vec3 tmpvar_17;
...
void main ()
{
  ...
  tmpvar_31 = max (0.000000, dot (tmpvar_18, normalize((lightDir_26 + viewDir_27))));
  nh_30 = tmpvar_31;
  mediump float arg1_32;
  arg1_32 = (tmpvar_4 * 128.000);
  res_29.xyz = (_LightColor0.xyz * max (0.000000, dot (lightDir_26, tmpvar_18)));
  ...
  res_29 = tmpvar_35;
  mediump vec4 c_36;
  c_36.xyz = ((tmpvar_2 * tmpvar_35.xyz) + (tmpvar_35.xyz * (tmpvar_35.w * tmpvar_3)));
  c_36.w = tmpvar_5;
  c_1 = c_36;
...
void main ()
{
  ...
  highp float nh_25;
  mediump float tmpvar_26;
  tmpvar_26 = max (0.000000, dot (tmpvar_18, normalize((lightDir_21 + viewDir_22))));
  nh_25 = tmpvar_26;
  mediump float arg1_27;
  arg1_27 = (tmpvar_4 * 128.000);
  res_24.xyz = (_LightColor0.xyz * max (0.000000, dot (lightDir_21, tmpvar_18)));
  lowp float tmpvar_28;
  tmpvar_28 = dot (_LightColor0.xyz, vec3(0.220000, 0.707000, 0.0710000));
  highp float tmpvar_29;
  tmpvar_29 = (pow (nh_25, arg1_27) * tmpvar_28);
  res_24.w = tmpvar_29;
  mediump vec4 tmpvar_30;
  tmpvar_30 = (res_24 * (atten_23 * 2.00000));
  res_24 = tmpvar_30;
  mediump vec4 c_31;
  c_31.xyz = ((tmpvar_2 * tmpvar_30.xyz) + (tmpvar_30.xyz * (tmpvar_30.w * tmpvar_3)));
  c_31.w = tmpvar_5;
  c_1 = c_31;
  mediump vec3 tmpvar_32;
  tmpvar_32 = (c_1.xyz + (tmpvar_2 * xlv_TEXCOORD2));
  c_1.xyz = tmpvar_32;
...
void main ()
{
  ...
  tmpvar_18 = texture2DProj (_ShadowMapTexture, xlv_TEXCOORD2).x;
  dist_17 = tmpvar_18;
  highp float tmpvar_19;
  tmpvar_19 = _LightShadowData.x;
  lightShadowDataX_16 = tmpvar_19;
  highp float tmpvar_20;
  tmpvar_20 = max (float((dist_17 > (xlv_TEXCOORD2.z / xlv_TEXCOORD2.w))), lightShadowDataX_16);
  tmpvar_15 = tmpvar_20;
  lowp vec3 tmpvar_21;
  tmpvar_21 = min ((2.00000 * texture2D (unity_Lightmap, xlv_TEXCOORD1).xyz), vec3((tmpvar_15 * 2.00000)));
...
void main ()
{
  ...
  tmpvar_3 = tmpvar_14;
  lowp vec4 tmpvar_15;
  tmpvar_15 = texture2DProj (_ShadowMapTexture, xlv_TEXCOORD2);
  lowp vec4 tmpvar_16;
  tmpvar_16 = texture2D (unity_Lightmap, xlv_TEXCOORD1);
  lowp vec3 tmpvar_17;
  tmpvar_17 = ((8.00000 * tmpvar_16.w) * tmpvar_16.xyz);
  lowp vec3 tmpvar_18;
  tmpvar_18 = max (min (tmpvar_17, ((tmpvar_15.x * 2.00000) * tmpvar_16.xyz)), (tmpvar_17 * tmpvar_15.x));
...
Program "fp" {
// Fragment combos: 4
//   opengl - ALU: 29 to 50, TEX: 1 to 3
//   d3d9 - ALU: 38 to 62, TEX: 1 to 3
SubProgram "opengl " {
Keywords { "DIRECTIONAL" "LIGHTMAP_OFF" "DIRLIGHTMAP_OFF" "SHADOWS_OFF" }
Vector 0 [_Time]
...
POW R0.x, R0.w, R2.x;
MUL R0.w, R0.x, R0.y;
MAX R0.x, fragment.texcoord[1].z, c[9].z;
MUL R2.x, R2.w, c[4];
MUL R0.xyz, R0.x, c[1];
MUL R0, R0, c[10].w;
MUL R2.xyz, R2.x, c[3];
...
ADD R0.y, fragment.texcoord[0], -c[8];
MUL R0.z, R0.y, R0.w;
ADD R1.y, fragment.texcoord[0].x, -c[8].x;
MUL R0.y, R1.x, R0;
MAD R0.y, R1, R0.w, R0;
...
POW R1.y, R2.y, R2.x;
MUL R2.w, R1.y, R1.x;
MAX R1.x, fragment.texcoord[1].z, c[9].z;
MUL R2.xyz, R1.x, c[1];
...
void main ()
{
  ...
  tmpvar_17 = ((Tex2D0_7.wwww * vec4(_Specular)) * _SpecularColor).xyz;
  tmpvar_4 = tmpvar_17;
...
void main ()
{
  ...
  tmpvar_20 = -(log2(max (light_3, vec4(0.00100000, 0.00100000, 0.00100000, 0.00100000))));
  light_3.w = tmpvar_20.w;
  highp vec3 tmpvar_21;
  tmpvar_21 = (tmpvar_20.xyz + xlv_TEXCOORD2);
  light_3.xyz = tmpvar_21;
  mediump vec4 c_22;
  c_22.xyz = ((tmpvar_4 * light_3.xyz) + (light_3.xyz * (tmpvar_20.w * tmpvar_5)));
  c_22.w = tmpvar_6;
  c_2.w = c_22.w;
  c_2.xyz = c_22.xyz;
  tmpvar_1 = c_2;
...
void main ()
{
  ...
  tmpvar_18 = (mix (tmpvar_17, Tex2D0_9, tmpvar_17) * _MainColor).xyz;
  tmpvar_6 = tmpvar_18;
  highp vec3 tmpvar_19;
  tmpvar_19 = ((Tex2D0_9.wwww * vec4(_Specular)) * _SpecularColor).xyz;
  tmpvar_7 = tmpvar_19;
  highp float tmpvar_20;
  ...
  light_5 = tmpvar_21;
  mediump vec4 tmpvar_22;
  tmpvar_22 = -(log2(max (light_5, vec4(0.00100000, 0.00100000, 0.00100000, 0.00100000))));
  light_5.w = tmpvar_22.w;
  lowp vec3 tmpvar_23;
  ...
  light_5.xyz = (tmpvar_22.xyz + mix (lmIndirect_3, lmFull_4, vec3(tmpvar_25)));
  mediump vec4 c_26;
  c_26.xyz = ((tmpvar_6 * light_5.xyz) + (light_5.xyz * (tmpvar_22.w * tmpvar_7)));
  c_26.w = tmpvar_8;
  c_2.w = c_26.w;
  c_2.xyz = c_26.xyz;
  tmpvar_1 = c_2;
...
void main ()
{
  ...
  highp float tmpvar_27;
  tmpvar_27 = clamp (((sqrt(dot (xlv_TEXCOORD3, xlv_TEXCOORD3)) * unity_LightmapFade.z) + unity_LightmapFade.w), 0.000000, 1.00000);
  light_5.xyz = (tmpvar_22.xyz + mix (lmIndirect_3, lmFull_4, vec3(tmpvar_27)));
  mediump vec4 c_28;
  c_28.xyz = ((tmpvar_6 * light_5.xyz) + (light_5.xyz * (tmpvar_22.w * tmpvar_7)));
  c_28.w = tmpvar_8;
  c_2.w = c_28.w;
  c_2.xyz = c_28.xyz;
  tmpvar_1 = c_2;
...
void main ()
{
  ...
  light_3 = tmpvar_19;
  mediump vec4 tmpvar_20;
  tmpvar_20 = max (light_3, vec4(0.00100000, 0.00100000, 0.00100000, 0.00100000));
  light_3.w = tmpvar_20.w;
  highp vec3 tmpvar_21;
  tmpvar_21 = (tmpvar_20.xyz + xlv_TEXCOORD2);
  light_3.xyz = tmpvar_21;
...
void main ()
{
  ...
  light_5 = tmpvar_21;
  mediump vec4 tmpvar_22;
  tmpvar_22 = max (light_5, vec4(0.00100000, 0.00100000, 0.00100000, 0.00100000));
  light_5.w = tmpvar_22.w;
  lowp vec3 tmpvar_23;
  tmpvar_23 = (2.00000 * texture2D (unity_Lightmap, xlv_TEXCOORD2).xyz);
  lmFull_4 = tmpvar_23;
