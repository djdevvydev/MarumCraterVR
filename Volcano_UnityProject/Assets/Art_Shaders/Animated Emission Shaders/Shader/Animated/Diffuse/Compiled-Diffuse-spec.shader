Shader "Animated/Diffuse/Diffuse Specular"
{
	Properties 
	{
...
void main ()
{
  ...
  lowp vec4 tmpvar_16;
  tmpvar_16 = texture2D (_Specular, tmpvar_13.xy);
  Tex2D1_6 = tmpvar_16;
  highp vec3 tmpvar_17;
  tmpvar_17 = (mix (tmpvar_15, Tex2D0_7, tmpvar_15) * _MainColor).xyz;
  tmpvar_2 = tmpvar_17;
  tmpvar_4 = _Gloss;
  highp vec3 tmpvar_18;
  tmpvar_18 = ((Tex2D1_6 * vec4(_SpecularPower)) * _SpecularColor).xyz;
  tmpvar_3 = tmpvar_18;
  highp float tmpvar_19;
  tmpvar_19 = tmpvar_15.x;
  tmpvar_5 = tmpvar_19;
  mediump vec3 tmpvar_20;
  tmpvar_20 = normalize(vec3(0.000000, 0.000000, 1.00000));
  ...
  highp float nh_25;
  mediump float tmpvar_26;
  tmpvar_26 = max (0.000000, dot (tmpvar_20, normalize((lightDir_22 + viewDir_23))));
  nh_25 = tmpvar_26;
  mediump float arg1_27;
  arg1_27 = (tmpvar_4 * 128.000);
  res_24.xyz = (_LightColor0.xyz * max (0.000000, dot (lightDir_22, tmpvar_20)));
...
void main ()
{
  ...
  tmpvar_26 = max (float((dist_23 > (xlv_TEXCOORD4.z / xlv_TEXCOORD4.w))), lightShadowDataX_22);
  tmpvar_21 = tmpvar_26;
  highp vec3 tmpvar_27;
  ...
  tmpvar_33 = max (0.000000, dot (tmpvar_20, normalize((lightDir_28 + viewDir_29))));
  nh_32 = tmpvar_33;
  mediump float arg1_34;
  arg1_34 = (tmpvar_4 * 128.000);
  res_31.xyz = (_LightColor0.xyz * max (0.000000, dot (lightDir_28, tmpvar_20)));
  ...
  res_31 = tmpvar_37;
  mediump vec4 c_38;
  c_38.xyz = ((tmpvar_2 * tmpvar_37.xyz) + (tmpvar_37.xyz * (tmpvar_37.w * tmpvar_3)));
  c_38.w = tmpvar_5;
  c_1 = c_38;
...
void main ()
{
  ...
  tmpvar_28 = max (0.000000, dot (tmpvar_20, normalize((lightDir_23 + viewDir_24))));
  nh_27 = tmpvar_28;
  mediump float arg1_29;
  arg1_29 = (tmpvar_4 * 128.000);
  res_26.xyz = (_LightColor0.xyz * max (0.000000, dot (lightDir_23, tmpvar_20)));
  ...
  res_26 = tmpvar_32;
  mediump vec4 c_33;
  c_33.xyz = ((tmpvar_2 * tmpvar_32.xyz) + (tmpvar_32.xyz * (tmpvar_32.w * tmpvar_3)));
  c_33.w = tmpvar_5;
  c_1 = c_33;
...
Program "fp" {
// Fragment combos: 4
//   opengl - ALU: 29 to 51, TEX: 2 to 3
//   d3d9 - ALU: 38 to 61, TEX: 2 to 3
SubProgram "opengl " {
Keywords { "DIRECTIONAL" "LIGHTMAP_OFF" "DIRLIGHTMAP_OFF" "SHADOWS_OFF" }
Vector 0 [_Time]
...
MUL R2.xyz, R0, c[4].x;
MAX R2.w, fragment.texcoord[1].z, c[9].z;
MUL R0.xyz, R2.w, c[1];
MUL R0, R0, c[10].w;
MUL R2.xyz, R2, c[3];
MUL R2.xyz, R0.w, R2;
...
mov_pp r0.xyz, c1
dp3_pp r2.w, c11, r0
max_pp r3.x, v1.z, c10.z
mul r1.xyz, r1, c2
mul r2.xyz, r2, c3
mul_pp r0.xyz, r3.x, c1
mul r0.w, r0, r2
mul_pp r0, r0, c11.w
...
void main ()
{
  ...
  lowp vec4 tmpvar_17;
  tmpvar_17 = texture2D (_Specular, tmpvar_14.xy);
  Tex2D1_7 = tmpvar_17;
  highp vec3 tmpvar_18;
  ...
  tmpvar_19 = ((Tex2D1_7 * vec4(_SpecularPower)) * _SpecularColor).xyz;
  tmpvar_4 = tmpvar_19;
  highp float tmpvar_20;
  tmpvar_20 = tmpvar_16.x;
  tmpvar_6 = tmpvar_20;
  mediump vec3 tmpvar_21;
  tmpvar_21 = normalize(vec3(0.000000, 0.000000, 1.00000));
  mediump vec3 tmpvar_22;
  ...
  tmpvar_29 = max (0.000000, dot (tmpvar_21, normalize((lightDir_25 + normalize(xlv_TEXCOORD2)))));
  nh_28 = tmpvar_29;
  mediump float arg1_30;
  arg1_30 = (tmpvar_5 * 128.000);
  res_27.xyz = (_LightColor0.xyz * max (0.000000, dot (lightDir_25, tmpvar_21)));
...
void main ()
{
  ...
  tmpvar_25 = max (0.000000, dot (tmpvar_21, normalize((lightDir_22 + normalize(xlv_TEXCOORD2)))));
  nh_24 = tmpvar_25;
  mediump float arg1_26;
  arg1_26 = (tmpvar_5 * 128.000);
  res_23.xyz = (_LightColor0.xyz * max (0.000000, dot (lightDir_22, tmpvar_21)));
...
void main ()
{
  ...
  lowp vec4 tmpvar_23;
  highp vec2 P_24;
  P_24 = ((xlv_TEXCOORD3.xy / xlv_TEXCOORD3.w) + 0.500000);
  ...
  atten_28 = ((float((xlv_TEXCOORD3.z > 0.000000)) * tmpvar_23.w) * tmpvar_26.w);
  mediump vec4 res_29;
  highp float nh_30;
  mediump float tmpvar_31;
  tmpvar_31 = max (0.000000, dot (tmpvar_21, normalize((lightDir_27 + normalize(xlv_TEXCOORD2)))));
  nh_30 = tmpvar_31;
  mediump float arg1_32;
  arg1_32 = (tmpvar_5 * 128.000);
  res_29.xyz = (_LightColor0.xyz * max (0.000000, dot (lightDir_27, tmpvar_21)));
  ...
  res_29 = tmpvar_35;
  mediump vec4 c_36;
  c_36.xyz = ((tmpvar_3 * tmpvar_35.xyz) + (tmpvar_35.xyz * (tmpvar_35.w * tmpvar_4)));
  c_36.w = tmpvar_6;
  c_1.xyz = c_36.xyz;
  c_1.w = 0.000000;
  gl_FragData[0] = c_1;
...
void main ()
{
  ...
  tmpvar_30 = max (0.000000, dot (tmpvar_21, normalize((lightDir_26 + normalize(xlv_TEXCOORD2)))));
  nh_29 = tmpvar_30;
  mediump float arg1_31;
  arg1_31 = (tmpvar_5 * 128.000);
  res_28.xyz = (_LightColor0.xyz * max (0.000000, dot (lightDir_26, tmpvar_21)));
  ...
  res_28 = tmpvar_34;
  mediump vec4 c_35;
  c_35.xyz = ((tmpvar_3 * tmpvar_34.xyz) + (tmpvar_34.xyz * (tmpvar_34.w * tmpvar_4)));
  c_35.w = tmpvar_6;
  c_1.xyz = c_35.xyz;
  c_1.w = 0.000000;
  gl_FragData[0] = c_1;
...
void main ()
{
  ...
  highp float nh_26;
  mediump float tmpvar_27;
  tmpvar_27 = max (0.000000, dot (tmpvar_21, normalize((lightDir_23 + normalize(xlv_TEXCOORD2)))));
  nh_26 = tmpvar_27;
  mediump float arg1_28;
  arg1_28 = (tmpvar_5 * 128.000);
  res_25.xyz = (_LightColor0.xyz * max (0.000000, dot (lightDir_23, tmpvar_21)));
...
Program "fp" {
// Fragment combos: 5
//   opengl - ALU: 48 to 58, TEX: 2 to 4
//   d3d9 - ALU: 60 to 68, TEX: 2 to 4
SubProgram "opengl " {
Keywords { "POINT" }
Vector 0 [_Time]
Vector 1 [_LightColor0]
...
RSQ R0.w, R0.w;
MAD R0.xyw, R0.w, fragment.texcoord[2].xyzz, R0.xyzz;
...
MAX R2.z, R0.x, c[9].x;
MUL R2.w, R0.y, c[5].x;
MOV R0.xyw, c[10].xyzz;
POW R2.w, R2.z, R2.w;
DP3 R0.x, R0.xyww, c[1];
MUL R0.w, R2, R0.x;
...
texld r1.xyz, r1, s1
mul_pp r3.xyw, r0.y, v1.xyzz
rsq_pp r0.x, r0.x
mad_pp r0.xyz, r0.x, v2, r3.xyww
dp3_pp r0.x, r0, r0
rsq_pp r0.x, r0.x
mul r3.xyz, r1, c4.x
mov_pp r0.y, c5.x
mul_pp r0.x, r0, r0.z
mul_pp r1.y, c10.w, r0
max_pp r1.x, r0, c10.z
pow r0, r1.x, r1.y
mov_pp r1.xyz, c1
dp3_pp r0.y, c11, r1
mul r1.w, r0.x, r0.y
max_pp r0.y, r3.w, c10.z
dp3 r0.x, v3, v3
...
TEX R0.xyz, R0, texture[1], 2D;
MUL R2.xyz, R0, c[4].x;
MAX R2.w, fragment.texcoord[1].z, c[9].x;
MUL R0.xyz, R2.w, c[1];
MUL R0, R0, c[10].w;
MUL R2.xyz, R2, c[3];
MUL R2.xyz, R0.w, R2;
...
mov_pp r0.y, c5.x
mul_pp r0.x, r0, r0.z
mul_pp r3.y, c10.w, r0
max_pp r3.x, r0, c10.z
pow r0, r3.x, r3.y
mul r3.xyz, r1, c4.x
mov r0.y, r0.x
mov_pp r1.xyz, c1
...
void main ()
{
  ...
  light_3 = tmpvar_21;
  mediump vec4 tmpvar_22;
  tmpvar_22 = -(log2(max (light_3, vec4(0.00100000, 0.00100000, 0.00100000, 0.00100000))));
  light_3.w = tmpvar_22.w;
  highp vec3 tmpvar_23;
  tmpvar_23 = (tmpvar_22.xyz + xlv_TEXCOORD2);
  light_3.xyz = tmpvar_23;
  mediump vec4 c_24;
  c_24.xyz = ((tmpvar_4 * light_3.xyz) + (light_3.xyz * (tmpvar_22.w * tmpvar_5)));
  c_24.w = tmpvar_6;
  c_2.w = c_24.w;
  c_2.xyz = c_24.xyz;
  tmpvar_1 = c_2;
...
void main ()
{
  ...
  lowp vec4 tmpvar_19;
  tmpvar_19 = texture2D (_Specular, tmpvar_16.xy);
  Tex2D1_9 = tmpvar_19;
  highp vec3 tmpvar_20;
  tmpvar_20 = (mix (tmpvar_18, Tex2D0_10, tmpvar_18) * _MainColor).xyz;
  tmpvar_6 = tmpvar_20;
  highp vec3 tmpvar_21;
  tmpvar_21 = ((Tex2D1_9 * vec4(_SpecularPower)) * _SpecularColor).xyz;
  tmpvar_7 = tmpvar_21;
  highp float tmpvar_22;
  tmpvar_22 = tmpvar_18.x;
  tmpvar_8 = tmpvar_22;
  lowp vec4 tmpvar_23;
  tmpvar_23 = texture2DProj (_LightBuffer, xlv_TEXCOORD1);
  light_5 = tmpvar_23;
  mediump vec4 tmpvar_24;
  tmpvar_24 = -(log2(max (light_5, vec4(0.00100000, 0.00100000, 0.00100000, 0.00100000))));
  light_5.w = tmpvar_24.w;
  lowp vec3 tmpvar_25;
  tmpvar_25 = (2.00000 * texture2D (unity_Lightmap, xlv_TEXCOORD2).xyz);
  lmFull_4 = tmpvar_25;
  lowp vec3 tmpvar_26;
  tmpvar_26 = (2.00000 * texture2D (unity_LightmapInd, xlv_TEXCOORD2).xyz);
  ...
  light_5.xyz = (tmpvar_24.xyz + mix (lmIndirect_3, lmFull_4, vec3(tmpvar_27)));
  mediump vec4 c_28;
  c_28.xyz = ((tmpvar_6 * light_5.xyz) + (light_5.xyz * (tmpvar_24.w * tmpvar_7)));
  c_28.w = tmpvar_8;
  c_2.w = c_28.w;
  c_2.xyz = c_28.xyz;
  tmpvar_1 = c_2;
...
void main ()
{
  ...
  light_5.w = tmpvar_24.w;
  lowp vec4 tmpvar_25;
  tmpvar_25 = texture2D (unity_Lightmap, xlv_TEXCOORD2);
  lowp vec3 tmpvar_26;
  ...
  light_5.xyz = (tmpvar_24.xyz + mix (lmIndirect_3, lmFull_4, vec3(tmpvar_29)));
  mediump vec4 c_30;
  c_30.xyz = ((tmpvar_6 * light_5.xyz) + (light_5.xyz * (tmpvar_24.w * tmpvar_7)));
  c_30.w = tmpvar_8;
  c_2.w = c_30.w;
  c_2.xyz = c_30.xyz;
  tmpvar_1 = c_2;
...
void main ()
{
  ...
  light_3 = tmpvar_21;
  mediump vec4 tmpvar_22;
  tmpvar_22 = max (light_3, vec4(0.00100000, 0.00100000, 0.00100000, 0.00100000));
  light_3.w = tmpvar_22.w;
  highp vec3 tmpvar_23;
  tmpvar_23 = (tmpvar_22.xyz + xlv_TEXCOORD2);
  light_3.xyz = tmpvar_23;
...
void main ()
{
  ...
  light_5 = tmpvar_23;
  mediump vec4 tmpvar_24;
  tmpvar_24 = max (light_5, vec4(0.00100000, 0.00100000, 0.00100000, 0.00100000));
  light_5.w = tmpvar_24.w;
  lowp vec3 tmpvar_25;
  tmpvar_25 = (2.00000 * texture2D (unity_Lightmap, xlv_TEXCOORD2).xyz);
  lmFull_4 = tmpvar_25;
