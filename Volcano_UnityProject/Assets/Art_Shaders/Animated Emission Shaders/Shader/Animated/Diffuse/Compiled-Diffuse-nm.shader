Shader "Animated/Diffuse/Diffuse Normalmap"
{
	Properties 
	{
...
void main ()
{
  ...
  tmpvar_19 = Tex2DNormal0_7.xyz;
  tmpvar_3 = tmpvar_19;
  tmpvar_5 = _Gloss;
  highp vec3 tmpvar_20;
  tmpvar_20 = ((Tex2D0_8.wwww * vec4(_Specular)) * _SpecularColor).xyz;
  tmpvar_4 = tmpvar_20;
  highp float tmpvar_21;
...
void main ()
{
  ...
  tmpvar_21 = ((Tex2D0_8.wwww * vec4(_Specular)) * _SpecularColor).xyz;
  tmpvar_4 = tmpvar_21;
...
Program "fp" {
// Fragment combos: 4
//   opengl - ALU: 29 to 61, TEX: 2 to 3
//   d3d9 - ALU: 38 to 72, TEX: 2 to 3
SubProgram "opengl " {
Keywords { "DIRECTIONAL" "LIGHTMAP_OFF" "DIRLIGHTMAP_OFF" "SHADOWS_OFF" }
Vector 0 [_Time]
...
void main ()
{
  ...
  tmpvar_6 = _Gloss;
  highp vec3 tmpvar_21;
  tmpvar_21 = ((Tex2D0_9.wwww * vec4(_Specular)) * _SpecularColor).xyz;
  tmpvar_5 = tmpvar_21;
  highp float tmpvar_22;
...
void main ()
{
  ...
  tmpvar_22 = ((Tex2D0_9.wwww * vec4(_Specular)) * _SpecularColor).xyz;
  tmpvar_5 = tmpvar_22;
  highp float tmpvar_23;
...
void main ()
{
  ...
  tmpvar_6 = tmpvar_21;
  highp vec3 tmpvar_22;
  tmpvar_22 = Tex2DNormal0_10.xyz;
  tmpvar_7 = tmpvar_22;
  highp vec3 tmpvar_23;
  tmpvar_23 = ((Tex2D0_11.wwww * vec4(_Specular)) * _SpecularColor).xyz;
  tmpvar_8 = tmpvar_23;
  highp float tmpvar_24;
...
void main ()
{
  ...
  tmpvar_7 = tmpvar_23;
  highp vec3 tmpvar_24;
  tmpvar_24 = ((Tex2D0_11.wwww * vec4(_Specular)) * _SpecularColor).xyz;
  tmpvar_8 = tmpvar_24;
  highp float tmpvar_25;
...
Program "fp" {
// Fragment combos: 4
//   opengl - ALU: 32 to 47, TEX: 2 to 4
//   d3d9 - ALU: 41 to 54, TEX: 2 to 4
SubProgram "opengl " {
Keywords { "LIGHTMAP_OFF" "DIRLIGHTMAP_OFF" "HDR_LIGHT_PREPASS_OFF" }
Vector 0 [_Time]
Vector 1 [_MainColor]
...
SIN R2.z, R1.w;
MUL R1.xyz, R1, c[8].z;
ADD R2.y, fragment.texcoord[0], -c[6];
MUL R2.w, R2.y, R2.z;
ADD R2.x, fragment.texcoord[0], -c[6];
COS R1.w, R1.w;
MAD R2.w, R2.x, R1, -R2;
MUL R1.w, R1, R2.y;
ADD R2.w, -R2, c[6].x;
MAD R2.y, R0.w, -c[5].x, R2.w;
MAD R1.w, R2.x, R2.z, R1;
ADD R2.x, R2.y, c[8].y;
ADD R2.y, -R1.w, c[6];
MAD R2.y, R0.w, -c[5], R2;
...
texld r2, v2, s3
mov r0.y, c5
mad r0.y, c0.x, -r0, r0.z
dp4 r0.w, v3, v3
mul_pp r1.xyz, r1, c9.z
mul_pp r2.xyz, r2.w, r2
mad_pp r2.xyz, r2, c9.z, -r1
add r1.w, -r1, c6.x
mov r0.x, c5
mad r0.x, c0, -r0, r1.w
rsq r0.z, r0.w
