Shader "Animated/Self-Emission/Diffuse Normalmap Specular"
{
	Properties 
	{
...
void main ()
{
  ...
  Tex2D2_9 = tmpvar_22;
  lowp vec4 tmpvar_23;
  tmpvar_23 = texture2D (_Specular, tmpvar_17.xy);
  Tex2D1_8 = tmpvar_23;
  ...
  tmpvar_6 = _Gloss;
  highp vec3 tmpvar_27;
  tmpvar_27 = ((Tex2D1_8 * vec4(_SpecularPower)) * _SpecularColor).xyz;
  tmpvar_5 = tmpvar_27;
  highp float tmpvar_28;
  tmpvar_28 = tmpvar_19.x;
  tmpvar_7 = tmpvar_28;
  mediump vec3 tmpvar_29;
  tmpvar_29 = normalize(tmpvar_3);
  tmpvar_3 = tmpvar_29;
  ...
  tmpvar_35 = max (0.000000, dot (tmpvar_29, normalize((lightDir_31 + viewDir_32))));
  nh_34 = tmpvar_35;
  mediump float arg1_36;
  arg1_36 = (tmpvar_6 * 128.000);
  res_33.xyz = (_LightColor0.xyz * max (0.000000, dot (lightDir_31, tmpvar_29)));
...
void main ()
{
  ...
  Tex2D2_9 = tmpvar_23;
  lowp vec4 tmpvar_24;
  tmpvar_24 = texture2D (_Specular, tmpvar_17.xy);
  Tex2D1_8 = tmpvar_24;
  highp vec3 tmpvar_25;
  tmpvar_25 = tmpvar_20.xyz;
  tmpvar_2 = tmpvar_25;
  highp vec3 tmpvar_26;
  tmpvar_26 = Tex2DNormal0_10.xyz;
  tmpvar_3 = tmpvar_26;
  highp vec3 tmpvar_27;
  tmpvar_27 = ((Tex2D2_9 * tmpvar_20) * _EmissionColor).xyz;
  tmpvar_4 = tmpvar_27;
  tmpvar_6 = _Gloss;
  highp vec3 tmpvar_28;
  tmpvar_28 = ((Tex2D1_8 * vec4(_SpecularPower)) * _SpecularColor).xyz;
  tmpvar_5 = tmpvar_28;
  highp float tmpvar_29;
  tmpvar_29 = tmpvar_19.x;
  tmpvar_7 = tmpvar_29;
  mediump vec3 tmpvar_30;
  tmpvar_30 = normalize(tmpvar_3);
  tmpvar_3 = tmpvar_30;
  ...
  tmpvar_36 = max (0.000000, dot (tmpvar_30, normalize((lightDir_32 + viewDir_33))));
  nh_35 = tmpvar_36;
  mediump float arg1_37;
  arg1_37 = (tmpvar_6 * 128.000);
  res_34.xyz = (_LightColor0.xyz * max (0.000000, dot (lightDir_32, tmpvar_30)));
...
void main ()
{
  ...
  tmpvar_33 = texture2DProj (_ShadowMapTexture, xlv_TEXCOORD4).x;
  dist_32 = tmpvar_33;
  highp float tmpvar_34;
  tmpvar_34 = _LightShadowData.x;
  lightShadowDataX_31 = tmpvar_34;
  highp float tmpvar_35;
  tmpvar_35 = max (float((dist_32 > (xlv_TEXCOORD4.z / xlv_TEXCOORD4.w))), lightShadowDataX_31);
  tmpvar_30 = tmpvar_35;
  highp vec3 tmpvar_36;
  tmpvar_36 = normalize(xlv_TEXCOORD3);
  mediump vec3 lightDir_37;
  lightDir_37 = xlv_TEXCOORD1;
  ...
  tmpvar_42 = max (0.000000, dot (tmpvar_29, normalize((lightDir_37 + viewDir_38))));
  nh_41 = tmpvar_42;
  mediump float arg1_43;
  arg1_43 = (tmpvar_6 * 128.000);
  res_40.xyz = (_LightColor0.xyz * max (0.000000, dot (lightDir_37, tmpvar_29)));
  lowp float tmpvar_44;
  tmpvar_44 = dot (_LightColor0.xyz, vec3(0.220000, 0.707000, 0.0710000));
  highp float tmpvar_45;
  tmpvar_45 = (pow (nh_41, arg1_43) * tmpvar_44);
  res_40.w = tmpvar_45;
  mediump vec4 tmpvar_46;
  tmpvar_46 = (res_40 * (atten_39 * 2.00000));
  res_40 = tmpvar_46;
  mediump vec4 c_47;
  c_47.xyz = ((tmpvar_2 * tmpvar_46.xyz) + (tmpvar_46.xyz * (tmpvar_46.w * tmpvar_5)));
  c_47.w = tmpvar_7;
  c_1 = c_47;
  mediump vec3 tmpvar_48;
  tmpvar_48 = (c_1.xyz + (tmpvar_2 * xlv_TEXCOORD2));
  c_1.xyz = tmpvar_48;
  mediump vec3 tmpvar_49;
  tmpvar_49 = (c_1.xyz + tmpvar_4);
  c_1.xyz = tmpvar_49;
  gl_FragData[0] = c_1;
}
...
void main ()
{
  ...
  tmpvar_38 = max (0.000000, dot (tmpvar_30, normalize((lightDir_33 + viewDir_34))));
  nh_37 = tmpvar_38;
  mediump float arg1_39;
  arg1_39 = (tmpvar_6 * 128.000);
  res_36.xyz = (_LightColor0.xyz * max (0.000000, dot (lightDir_33, tmpvar_30)));
  lowp float tmpvar_40;
  tmpvar_40 = dot (_LightColor0.xyz, vec3(0.220000, 0.707000, 0.0710000));
  highp float tmpvar_41;
  tmpvar_41 = (pow (nh_37, arg1_39) * tmpvar_40);
  res_36.w = tmpvar_41;
  mediump vec4 tmpvar_42;
  tmpvar_42 = (res_36 * (atten_35 * 2.00000));
  res_36 = tmpvar_42;
  mediump vec4 c_43;
  c_43.xyz = ((tmpvar_2 * tmpvar_42.xyz) + (tmpvar_42.xyz * (tmpvar_42.w * tmpvar_5)));
  c_43.w = tmpvar_7;
  c_1 = c_43;
  mediump vec3 tmpvar_44;
  tmpvar_44 = (c_1.xyz + (tmpvar_2 * xlv_TEXCOORD2));
  c_1.xyz = tmpvar_44;
  mediump vec3 tmpvar_45;
  tmpvar_45 = (c_1.xyz + tmpvar_4);
  c_1.xyz = tmpvar_45;
  gl_FragData[0] = c_1;
}
...
Program "fp" {
// Fragment combos: 4
//   opengl - ALU: 32 to 66, TEX: 3 to 5
//   d3d9 - ALU: 40 to 75, TEX: 3 to 5
SubProgram "opengl " {
Keywords { "DIRECTIONAL" "LIGHTMAP_OFF" "DIRLIGHTMAP_OFF" "SHADOWS_OFF" }
Vector 0 [_Time]
...
DP3 R1.w, R1, R0;
MOV R0, c[11];
DP3 R1.y, R1, fragment.texcoord[1];
DP3 R0.w, R0.yzww, c[1];
MAX R1.w, R1, c[10];
MUL R0.x, R0, c[5];
POW R1.x, R1.w, R0.x;
MAX R0.x, R1.y, c[10].w;
MUL R0.w, R1.x, R0;
MUL R0.xyz, R0.x, c[1];
MUL R1, R0, c[10].z;
...
void main ()
{
  ...
  tmpvar_21 = (mix (tmpvar_20, Tex2D0_12, tmpvar_20) * _MainColor);
  lowp vec4 tmpvar_22;
  tmpvar_22.w = 1.00000;
  tmpvar_22.xyz = ((texture2D (_Normalmap, tmpvar_18.xy).xyz * 2.00000) - 1.00000);
  Tex2DNormal0_11 = tmpvar_22;
  lowp vec4 tmpvar_23;
  tmpvar_23 = texture2D (_Emission, tmpvar_18.xy);
  Tex2D2_10 = tmpvar_23;
  lowp vec4 tmpvar_24;
  tmpvar_24 = texture2D (_Specular, tmpvar_18.xy);
  Tex2D1_9 = tmpvar_24;
  highp vec3 tmpvar_25;
  tmpvar_25 = tmpvar_21.xyz;
  tmpvar_4 = tmpvar_25;
  highp vec3 tmpvar_26;
  tmpvar_26 = Tex2DNormal0_11.xyz;
  tmpvar_5 = tmpvar_26;
  highp vec3 tmpvar_27;
  tmpvar_27 = ((Tex2D2_10 * tmpvar_21) * _EmissionColor).xyz;
  tmpvar_6 = tmpvar_27;
  highp vec3 tmpvar_28;
  tmpvar_28 = ((Tex2D1_9 * vec4(_SpecularPower)) * _SpecularColor).xyz;
  tmpvar_7 = tmpvar_28;
  highp float tmpvar_29;
  tmpvar_29 = tmpvar_20.x;
  tmpvar_8 = tmpvar_29;
  ...
  tmpvar_31 = -(log2(max (light_3, vec4(0.00100000, 0.00100000, 0.00100000, 0.00100000))));
  light_3.w = tmpvar_31.w;
  highp vec3 tmpvar_32;
  tmpvar_32 = (tmpvar_31.xyz + xlv_TEXCOORD2);
  light_3.xyz = tmpvar_32;
  mediump vec4 c_33;
  c_33.xyz = ((tmpvar_4 * light_3.xyz) + (light_3.xyz * (tmpvar_31.w * tmpvar_7)));
  c_33.w = tmpvar_8;
  c_2.w = c_33.w;
  c_2.xyz = (c_33.xyz + tmpvar_6);
  tmpvar_1 = c_2;
...
void main ()
{
  ...
  tmpvar_21 = (mix (tmpvar_20, Tex2D0_12, tmpvar_20) * _MainColor);
  lowp vec3 normal_22;
  normal_22.xy = ((texture2D (_Normalmap, tmpvar_18.xy).wy * 2.00000) - 1.00000);
  normal_22.z = sqrt(((1.00000 - (normal_22.x * normal_22.x)) - (normal_22.y * normal_22.y)));
  lowp vec4 tmpvar_23;
  tmpvar_23.w = 1.00000;
  tmpvar_23.xyz = normal_22;
  Tex2DNormal0_11 = tmpvar_23;
  lowp vec4 tmpvar_24;
  tmpvar_24 = texture2D (_Emission, tmpvar_18.xy);
  Tex2D2_10 = tmpvar_24;
  lowp vec4 tmpvar_25;
  tmpvar_25 = texture2D (_Specular, tmpvar_18.xy);
  Tex2D1_9 = tmpvar_25;
  highp vec3 tmpvar_26;
  tmpvar_26 = tmpvar_21.xyz;
  tmpvar_4 = tmpvar_26;
  highp vec3 tmpvar_27;
  tmpvar_27 = Tex2DNormal0_11.xyz;
  tmpvar_5 = tmpvar_27;
  highp vec3 tmpvar_28;
  tmpvar_28 = ((Tex2D2_10 * tmpvar_21) * _EmissionColor).xyz;
  tmpvar_6 = tmpvar_28;
  highp vec3 tmpvar_29;
  tmpvar_29 = ((Tex2D1_9 * vec4(_SpecularPower)) * _SpecularColor).xyz;
  tmpvar_7 = tmpvar_29;
  highp float tmpvar_30;
  tmpvar_30 = tmpvar_20.x;
  tmpvar_8 = tmpvar_30;
  tmpvar_5 = normalize(tmpvar_5);
  lowp vec4 tmpvar_31;
  ...
  tmpvar_32 = -(log2(max (light_3, vec4(0.00100000, 0.00100000, 0.00100000, 0.00100000))));
  light_3.w = tmpvar_32.w;
  highp vec3 tmpvar_33;
  tmpvar_33 = (tmpvar_32.xyz + xlv_TEXCOORD2);
  light_3.xyz = tmpvar_33;
  mediump vec4 c_34;
  c_34.xyz = ((tmpvar_4 * light_3.xyz) + (light_3.xyz * (tmpvar_32.w * tmpvar_7)));
  c_34.w = tmpvar_8;
  c_2.w = c_34.w;
  c_2.xyz = (c_34.xyz + tmpvar_6);
  tmpvar_1 = c_2;
  gl_FragData[0] = tmpvar_1;
}
...
void main ()
{
  ...
  highp vec4 tmpvar_15;
  tmpvar_15 = (xlv_TEXCOORD0.xxxx - _Rotation.xxxx);
  highp vec4 tmpvar_16;
  tmpvar_16 = ((_Rotation.zzzz * _Time) - vec4(3.14159, 3.14159, 3.14159, 3.14159));
  highp vec4 tmpvar_17;
  tmpvar_17 = cos(tmpvar_16);
  highp vec4 tmpvar_18;
  tmpvar_18 = (xlv_TEXCOORD0.yyyy - _Rotation.yyyy);
  highp vec4 tmpvar_19;
  tmpvar_19 = sin(tmpvar_16);
  highp vec4 tmpvar_20;
  tmpvar_20.x = ((vec4(1.00000, 1.00000, 1.00000, 1.00000) - (_Pan.xxxx * _Time)) + (_Rotation.xxxx - ((tmpvar_15 * tmpvar_17) - (tmpvar_18 * tmpvar_19)))).x;
  tmpvar_20.y = ((vec4(1.00000, 1.00000, 1.00000, 1.00000) - (_Pan.yyyy * _Time)) + (_Rotation.yyyy - ((tmpvar_15 * tmpvar_19) + (tmpvar_18 * tmpvar_17)))).x;
  tmpvar_20.z = 0.000000;
  tmpvar_20.w = 0.000000;
  lowp vec4 tmpvar_21;
  tmpvar_21 = texture2D (_Diffuse, tmpvar_20.xy);
  Tex2D0_14 = tmpvar_21;
  highp vec4 tmpvar_22;
  tmpvar_22 = (vec4(1.00000, 1.00000, 1.00000, 1.00000) - ((vec4(1.00000, 1.00000, 1.00000, 1.00000) - Tex2D0_14.wwww) * vec4(_Alpha)));
  highp vec4 tmpvar_23;
  tmpvar_23 = (mix (tmpvar_22, Tex2D0_14, tmpvar_22) * _MainColor);
  lowp vec4 tmpvar_24;
  tmpvar_24.w = 1.00000;
  tmpvar_24.xyz = ((texture2D (_Normalmap, tmpvar_20.xy).xyz * 2.00000) - 1.00000);
  Tex2DNormal0_13 = tmpvar_24;
  lowp vec4 tmpvar_25;
  tmpvar_25 = texture2D (_Emission, tmpvar_20.xy);
  Tex2D2_12 = tmpvar_25;
  lowp vec4 tmpvar_26;
  tmpvar_26 = texture2D (_Specular, tmpvar_20.xy);
  Tex2D1_11 = tmpvar_26;
  highp vec3 tmpvar_27;
  tmpvar_27 = tmpvar_23.xyz;
  tmpvar_6 = tmpvar_27;
  highp vec3 tmpvar_28;
  tmpvar_28 = Tex2DNormal0_13.xyz;
  tmpvar_7 = tmpvar_28;
  highp vec3 tmpvar_29;
  tmpvar_29 = ((Tex2D2_12 * tmpvar_23) * _EmissionColor).xyz;
  tmpvar_8 = tmpvar_29;
  highp vec3 tmpvar_30;
  tmpvar_30 = ((Tex2D1_11 * vec4(_SpecularPower)) * _SpecularColor).xyz;
  tmpvar_9 = tmpvar_30;
  ...
  lowp vec4 tmpvar_32;
  tmpvar_32 = texture2DProj (_LightBuffer, xlv_TEXCOORD1);
  light_5 = tmpvar_32;
  mediump vec4 tmpvar_33;
  tmpvar_33 = -(log2(max (light_5, vec4(0.00100000, 0.00100000, 0.00100000, 0.00100000))));
  light_5.w = tmpvar_33.w;
  lowp vec3 tmpvar_34;
  tmpvar_34 = (2.00000 * texture2D (unity_Lightmap, xlv_TEXCOORD2).xyz);
  lmFull_4 = tmpvar_34;
  lowp vec3 tmpvar_35;
  tmpvar_35 = (2.00000 * texture2D (unity_LightmapInd, xlv_TEXCOORD2).xyz);
  ...
  light_5.xyz = (tmpvar_33.xyz + mix (lmIndirect_3, lmFull_4, vec3(tmpvar_36)));
  mediump vec4 c_37;
  c_37.xyz = ((tmpvar_6 * light_5.xyz) + (light_5.xyz * (tmpvar_33.w * tmpvar_9)));
  c_37.w = tmpvar_10;
  c_2.w = c_37.w;
...
void main ()
{
  ...
  tmpvar_23 = (mix (tmpvar_22, Tex2D0_14, tmpvar_22) * _MainColor);
  lowp vec3 normal_24;
  normal_24.xy = ((texture2D (_Normalmap, tmpvar_20.xy).wy * 2.00000) - 1.00000);
  normal_24.z = sqrt(((1.00000 - (normal_24.x * normal_24.x)) - (normal_24.y * normal_24.y)));
  lowp vec4 tmpvar_25;
  tmpvar_25.w = 1.00000;
  tmpvar_25.xyz = normal_24;
  Tex2DNormal0_13 = tmpvar_25;
  lowp vec4 tmpvar_26;
  tmpvar_26 = texture2D (_Emission, tmpvar_20.xy);
  Tex2D2_12 = tmpvar_26;
  lowp vec4 tmpvar_27;
  tmpvar_27 = texture2D (_Specular, tmpvar_20.xy);
  Tex2D1_11 = tmpvar_27;
  highp vec3 tmpvar_28;
  tmpvar_28 = tmpvar_23.xyz;
  tmpvar_6 = tmpvar_28;
  highp vec3 tmpvar_29;
  tmpvar_29 = Tex2DNormal0_13.xyz;
  tmpvar_7 = tmpvar_29;
  highp vec3 tmpvar_30;
  tmpvar_30 = ((Tex2D2_12 * tmpvar_23) * _EmissionColor).xyz;
  tmpvar_8 = tmpvar_30;
  highp vec3 tmpvar_31;
  tmpvar_31 = ((Tex2D1_11 * vec4(_SpecularPower)) * _SpecularColor).xyz;
  tmpvar_9 = tmpvar_31;
  highp float tmpvar_32;
  tmpvar_32 = tmpvar_22.x;
  tmpvar_10 = tmpvar_32;
  tmpvar_7 = normalize(tmpvar_7);
  lowp vec4 tmpvar_33;
  ...
  light_5 = tmpvar_33;
  mediump vec4 tmpvar_34;
  tmpvar_34 = -(log2(max (light_5, vec4(0.00100000, 0.00100000, 0.00100000, 0.00100000))));
  light_5.w = tmpvar_34.w;
  lowp vec4 tmpvar_35;
  ...
  lmFull_4 = tmpvar_36;
  lowp vec4 tmpvar_37;
  tmpvar_37 = texture2D (unity_LightmapInd, xlv_TEXCOORD2);
  lowp vec3 tmpvar_38;
  tmpvar_38 = ((8.00000 * tmpvar_37.w) * tmpvar_37.xyz);
  lmIndirect_3 = tmpvar_38;
  highp float tmpvar_39;
  tmpvar_39 = clamp (((sqrt(dot (xlv_TEXCOORD3, xlv_TEXCOORD3)) * unity_LightmapFade.z) + unity_LightmapFade.w), 0.000000, 1.00000);
  light_5.xyz = (tmpvar_34.xyz + mix (lmIndirect_3, lmFull_4, vec3(tmpvar_39)));
  mediump vec4 c_40;
  c_40.xyz = ((tmpvar_6 * light_5.xyz) + (light_5.xyz * (tmpvar_34.w * tmpvar_9)));
  c_40.w = tmpvar_10;
  c_2.w = c_40.w;
  c_2.xyz = (c_40.xyz + tmpvar_8);
  tmpvar_1 = c_2;
  gl_FragData[0] = tmpvar_1;
}
...
void main ()
{
  ...
  light_3 = tmpvar_30;
  mediump vec4 tmpvar_31;
  tmpvar_31 = max (light_3, vec4(0.00100000, 0.00100000, 0.00100000, 0.00100000));
  light_3.w = tmpvar_31.w;
  highp vec3 tmpvar_32;
  tmpvar_32 = (tmpvar_31.xyz + xlv_TEXCOORD2);
  light_3.xyz = tmpvar_32;
...
void main ()
{
  ...
  light_3 = tmpvar_31;
  mediump vec4 tmpvar_32;
  tmpvar_32 = max (light_3, vec4(0.00100000, 0.00100000, 0.00100000, 0.00100000));
  light_3.w = tmpvar_32.w;
  highp vec3 tmpvar_33;
  tmpvar_33 = (tmpvar_32.xyz + xlv_TEXCOORD2);
  light_3.xyz = tmpvar_33;
...
void main ()
{
  ...
  light_5 = tmpvar_32;
  mediump vec4 tmpvar_33;
  tmpvar_33 = max (light_5, vec4(0.00100000, 0.00100000, 0.00100000, 0.00100000));
  light_5.w = tmpvar_33.w;
  lowp vec3 tmpvar_34;
  tmpvar_34 = (2.00000 * texture2D (unity_Lightmap, xlv_TEXCOORD2).xyz);
  lmFull_4 = tmpvar_34;
...
void main ()
{
  ...
  light_5 = tmpvar_33;
  mediump vec4 tmpvar_34;
  tmpvar_34 = max (light_5, vec4(0.00100000, 0.00100000, 0.00100000, 0.00100000));
  light_5.w = tmpvar_34.w;
  lowp vec4 tmpvar_35;
  tmpvar_35 = texture2D (unity_Lightmap, xlv_TEXCOORD2);
  lowp vec3 tmpvar_36;
...
Program "fp" {
// Fragment combos: 4
//   opengl - ALU: 37 to 52, TEX: 4 to 6
//   d3d9 - ALU: 44 to 57, TEX: 4 to 6
SubProgram "opengl " {
Keywords { "LIGHTMAP_OFF" "DIRLIGHTMAP_OFF" "HDR_LIGHT_PREPASS_OFF" }
Vector 0 [_Time]
Vector 1 [_MainColor]
...
ADD R2.w, R0, c[9].y;
ADD R0.xyz, -R2.w, R0;
MAD R1.xyz, R2.w, R0, R2.w;
TEX R0.xyz, R4, texture[2], 2D;
MUL R2.xyz, R1, c[1];
MUL R3.xyz, R2, R0;
TEX R0, fragment.texcoord[2], texture[5], 2D;
MUL R0.xyz, R0.w, R0;
