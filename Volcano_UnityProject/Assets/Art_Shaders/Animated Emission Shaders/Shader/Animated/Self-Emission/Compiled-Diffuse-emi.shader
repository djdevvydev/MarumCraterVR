Shader "Animated/Self-Emission/Diffuse"
{
	Properties 
	{
...
void main ()
{
  ...
  tmpvar_19 = tmpvar_17.xyz;
  tmpvar_2 = tmpvar_19;
  highp vec3 tmpvar_20;
  tmpvar_20 = ((Tex2D2_7 * tmpvar_17) * _EmissionColor).xyz;
  tmpvar_3 = tmpvar_20;
  tmpvar_5 = _Gloss;
  highp vec3 tmpvar_21;
  tmpvar_21 = ((Tex2D0_8.wwww * vec4(_SpecularPower)) * _SpecularColor).xyz;
  tmpvar_4 = tmpvar_21;
  highp float tmpvar_22;
  tmpvar_22 = tmpvar_16.x;
  tmpvar_6 = tmpvar_22;
  mediump vec3 tmpvar_23;
  tmpvar_23 = normalize(vec3(0.000000, 0.000000, 1.00000));
  highp vec3 tmpvar_24;
  tmpvar_24 = normalize(xlv_TEXCOORD3);
  mediump vec3 lightDir_25;
  lightDir_25 = xlv_TEXCOORD1;
  mediump vec3 viewDir_26;
  viewDir_26 = tmpvar_24;
  mediump vec4 res_27;
  highp float nh_28;
  mediump float tmpvar_29;
  tmpvar_29 = max (0.000000, dot (tmpvar_23, normalize((lightDir_25 + viewDir_26))));
  nh_28 = tmpvar_29;
  mediump float arg1_30;
  arg1_30 = (tmpvar_5 * 128.000);
  ...
  tmpvar_35 = (c_1.xyz + (tmpvar_2 * xlv_TEXCOORD2));
  c_1.xyz = tmpvar_35;
  mediump vec3 tmpvar_36;
  tmpvar_36 = (c_1.xyz + tmpvar_3);
  c_1.xyz = tmpvar_36;
  gl_FragData[0] = c_1;
}
...
void main ()
{
  ...
  tmpvar_15 = (mix (tmpvar_14, Tex2D0_6, tmpvar_14) * _MainColor);
  lowp vec4 tmpvar_16;
  tmpvar_16 = texture2D (_Emission, tmpvar_12.xy);
  Tex2D2_5 = tmpvar_16;
  highp vec3 tmpvar_17;
  tmpvar_17 = tmpvar_15.xyz;
  tmpvar_2 = tmpvar_17;
  highp vec3 tmpvar_18;
  tmpvar_18 = ((Tex2D2_5 * tmpvar_15) * _EmissionColor).xyz;
  tmpvar_3 = tmpvar_18;
  highp float tmpvar_19;
  tmpvar_19 = tmpvar_14.x;
  tmpvar_4 = tmpvar_19;
  lowp vec3 tmpvar_20;
  tmpvar_20 = (2.00000 * texture2D (unity_Lightmap, xlv_TEXCOORD1).xyz);
  mediump vec3 tmpvar_21;
  tmpvar_21 = (tmpvar_2 * tmpvar_20);
  c_1.xyz = tmpvar_21;
  c_1.w = tmpvar_4;
...
void main ()
{
  ...
  tmpvar_29 = max (float((dist_26 > (xlv_TEXCOORD4.z / xlv_TEXCOORD4.w))), lightShadowDataX_25);
  tmpvar_24 = tmpvar_29;
  ...
  tmpvar_36 = max (0.000000, dot (tmpvar_23, normalize((lightDir_31 + viewDir_32))));
  nh_35 = tmpvar_36;
  mediump float arg1_37;
  arg1_37 = (tmpvar_5 * 128.000);
  res_34.xyz = (_LightColor0.xyz * max (0.000000, dot (lightDir_31, tmpvar_23)));
  ...
  res_34 = tmpvar_40;
  mediump vec4 c_41;
  c_41.xyz = ((tmpvar_2 * tmpvar_40.xyz) + (tmpvar_40.xyz * (tmpvar_40.w * tmpvar_4)));
  c_41.w = tmpvar_6;
  c_1 = c_41;
...
void main ()
{
  ...
  tmpvar_31 = max (0.000000, dot (tmpvar_23, normalize((lightDir_26 + viewDir_27))));
  nh_30 = tmpvar_31;
  mediump float arg1_32;
  arg1_32 = (tmpvar_5 * 128.000);
  res_29.xyz = (_LightColor0.xyz * max (0.000000, dot (lightDir_26, tmpvar_23)));
...
void main ()
{
  ...
  tmpvar_23 = texture2DProj (_ShadowMapTexture, xlv_TEXCOORD2).x;
  dist_22 = tmpvar_23;
  highp float tmpvar_24;
  tmpvar_24 = _LightShadowData.x;
  lightShadowDataX_21 = tmpvar_24;
  highp float tmpvar_25;
  tmpvar_25 = max (float((dist_22 > (xlv_TEXCOORD2.z / xlv_TEXCOORD2.w))), lightShadowDataX_21);
  tmpvar_20 = tmpvar_25;
  lowp vec3 tmpvar_26;
  tmpvar_26 = min ((2.00000 * texture2D (unity_Lightmap, xlv_TEXCOORD1).xyz), vec3((tmpvar_20 * 2.00000)));
  mediump vec3 tmpvar_27;
  tmpvar_27 = (tmpvar_2 * tmpvar_26);
  c_1.xyz = tmpvar_27;
  c_1.w = tmpvar_4;
  mediump vec3 tmpvar_28;
  tmpvar_28 = (c_1.xyz + tmpvar_3);
  c_1.xyz = tmpvar_28;
  gl_FragData[0] = c_1;
}
...
Program "fp" {
// Fragment combos: 4
//   opengl - ALU: 32 to 54, TEX: 2 to 4
//   d3d9 - ALU: 40 to 65, TEX: 2 to 4
SubProgram "opengl " {
Keywords { "DIRECTIONAL" "LIGHTMAP_OFF" "DIRLIGHTMAP_OFF" "SHADOWS_OFF" }
Vector 0 [_Time]
...
MUL R0.y, R0.x, c[9].z;
ADD R0.y, R0, -c[10].x;
MAX R0.z, fragment.texcoord[1], c[10];
MUL R1.xyz, R0.z, c[1];
COS R0.z, R0.y;
SIN R0.w, R0.y;
ADD R0.y, fragment.texcoord[0], -c[9];
MUL R2.x, R0.y, R0.w;
MUL R2.y, R0.z, R0;
ADD R0.y, fragment.texcoord[0].x, -c[9].x;
MAD R0.w, R0.y, R0, R2.y;
MAD R0.y, R0, R0.z, -R2.x;
ADD R0.z, -R0.w, c[9].y;
MAD R0.z, R0.x, -c[8].y, R0;
ADD R0.y, -R0, c[9].x;
MAD R0.x, R0, -c[8], R0.y;
ADD R3.y, R0.z, c[10];
ADD R3.x, R0, c[10].y;
...
def c11, 6.28318501, -3.14159298, 0.00000000, 128.00000000
def c12, 0.21997070, 0.70703125, 0.07098389, 2.00000000
dcl_texcoord0 v0.xy
...
rsq_pp r2.x, r2.x
mov_pp r1.xyz, v1
mad_pp r1.xyz, r2.x, v3, r1
dp3_pp r1.x, r1, r1
mov_pp r1.y, c5.x
rsq_pp r1.x, r1.x
mul_pp r1.x, r1, r1.z
mul_pp r2.y, c11.w, r1
max_pp r2.x, r1, c11.z
pow r1, r2.x, r2.y
mul r0.w, r0, c4.x
mul r2.xyz, r0.w, c3
mov r0.w, r1.x
...
void main ()
{
  ...
  highp vec4 Tex2D0_7;
  highp vec4 tmpvar_8;
  tmpvar_8 = (xlv_TEXCOORD0.xxxx - _Rotation.xxxx);
  highp vec4 tmpvar_9;
  tmpvar_9 = ((_Rotation.zzzz * _Time) - vec4(3.14159, 3.14159, 3.14159, 3.14159));
  highp vec4 tmpvar_10;
  tmpvar_10 = cos(tmpvar_9);
  highp vec4 tmpvar_11;
  tmpvar_11 = (xlv_TEXCOORD0.yyyy - _Rotation.yyyy);
  highp vec4 tmpvar_12;
  tmpvar_12 = sin(tmpvar_9);
  highp vec4 tmpvar_13;
  tmpvar_13.x = ((vec4(1.00000, 1.00000, 1.00000, 1.00000) - (_Pan.xxxx * _Time)) + (_Rotation.xxxx - ((tmpvar_8 * tmpvar_10) - (tmpvar_11 * tmpvar_12)))).x;
  tmpvar_13.y = ((vec4(1.00000, 1.00000, 1.00000, 1.00000) - (_Pan.yyyy * _Time)) + (_Rotation.yyyy - ((tmpvar_8 * tmpvar_12) + (tmpvar_11 * tmpvar_10)))).x;
  tmpvar_13.z = 0.000000;
  tmpvar_13.w = 0.000000;
  lowp vec4 tmpvar_14;
  tmpvar_14 = texture2D (_Diffuse, tmpvar_13.xy);
  Tex2D0_7 = tmpvar_14;
  highp vec4 tmpvar_15;
  tmpvar_15 = (vec4(1.00000, 1.00000, 1.00000, 1.00000) - ((vec4(1.00000, 1.00000, 1.00000, 1.00000) - Tex2D0_7.wwww) * vec4(_Alpha)));
  highp vec3 tmpvar_16;
  tmpvar_16 = (mix (tmpvar_15, Tex2D0_7, tmpvar_15) * _MainColor).xyz;
  tmpvar_3 = tmpvar_16;
  tmpvar_5 = _Gloss;
  highp vec3 tmpvar_17;
  tmpvar_17 = ((Tex2D0_7.wwww * vec4(_SpecularPower)) * _SpecularColor).xyz;
  tmpvar_4 = tmpvar_17;
  highp float tmpvar_18;
  tmpvar_18 = tmpvar_15.x;
  tmpvar_6 = tmpvar_18;
  mediump vec3 tmpvar_19;
  tmpvar_19 = normalize(vec3(0.000000, 0.000000, 1.00000));
  mediump vec3 tmpvar_20;
  tmpvar_20 = normalize(xlv_TEXCOORD1);
  lightDir_2 = tmpvar_20;
  highp float tmpvar_21;
  tmpvar_21 = dot (xlv_TEXCOORD3, xlv_TEXCOORD3);
  lowp vec4 tmpvar_22;
  ...
  highp float nh_26;
  mediump float tmpvar_27;
  tmpvar_27 = max (0.000000, dot (tmpvar_19, normalize((lightDir_23 + normalize(xlv_TEXCOORD2)))));
  nh_26 = tmpvar_27;
  mediump float arg1_28;
  arg1_28 = (tmpvar_5 * 128.000);
  res_25.xyz = (_LightColor0.xyz * max (0.000000, dot (lightDir_23, tmpvar_19)));
  ...
  tmpvar_31 = (res_25 * (atten_24 * 2.00000));
  res_25 = tmpvar_31;
  mediump vec4 c_32;
  c_32.xyz = ((tmpvar_3 * tmpvar_31.xyz) + (tmpvar_31.xyz * (tmpvar_31.w * tmpvar_4)));
  c_32.w = tmpvar_6;
  c_1.xyz = c_32.xyz;
  c_1.w = 0.000000;
  gl_FragData[0] = c_1;
...
void main ()
{
  ...
  tmpvar_23 = max (0.000000, dot (tmpvar_19, normalize((lightDir_20 + normalize(xlv_TEXCOORD2)))));
  nh_22 = tmpvar_23;
  mediump float arg1_24;
  arg1_24 = (tmpvar_5 * 128.000);
  res_21.xyz = (_LightColor0.xyz * max (0.000000, dot (lightDir_20, tmpvar_19)));
  ...
  tmpvar_27 = (res_21 * 2.00000);
  res_21 = tmpvar_27;
  mediump vec4 c_28;
  c_28.xyz = ((tmpvar_3 * tmpvar_27.xyz) + (tmpvar_27.xyz * (tmpvar_27.w * tmpvar_4)));
  c_28.w = tmpvar_6;
  c_1.xyz = c_28.xyz;
  c_1.w = 0.000000;
  gl_FragData[0] = c_1;
...
void main ()
{
  ...
  lowp vec4 tmpvar_21;
  highp vec2 P_22;
  P_22 = ((xlv_TEXCOORD3.xy / xlv_TEXCOORD3.w) + 0.500000);
  ...
  atten_26 = ((float((xlv_TEXCOORD3.z > 0.000000)) * tmpvar_21.w) * tmpvar_24.w);
  mediump vec4 res_27;
  highp float nh_28;
  mediump float tmpvar_29;
  tmpvar_29 = max (0.000000, dot (tmpvar_19, normalize((lightDir_25 + normalize(xlv_TEXCOORD2)))));
  nh_28 = tmpvar_29;
  mediump float arg1_30;
  arg1_30 = (tmpvar_5 * 128.000);
  res_27.xyz = (_LightColor0.xyz * max (0.000000, dot (lightDir_25, tmpvar_19)));
  lowp float tmpvar_31;
  tmpvar_31 = dot (_LightColor0.xyz, vec3(0.220000, 0.707000, 0.0710000));
  highp float tmpvar_32;
  tmpvar_32 = (pow (nh_28, arg1_30) * tmpvar_31);
  ...
  res_27 = tmpvar_33;
  mediump vec4 c_34;
  c_34.xyz = ((tmpvar_3 * tmpvar_33.xyz) + (tmpvar_33.xyz * (tmpvar_33.w * tmpvar_4)));
  c_34.w = tmpvar_6;
  c_1.xyz = c_34.xyz;
  c_1.w = 0.000000;
  gl_FragData[0] = c_1;
...
void main ()
{
  ...
  highp float nh_27;
  mediump float tmpvar_28;
  tmpvar_28 = max (0.000000, dot (tmpvar_19, normalize((lightDir_24 + normalize(xlv_TEXCOORD2)))));
  nh_27 = tmpvar_28;
  mediump float arg1_29;
  arg1_29 = (tmpvar_5 * 128.000);
  res_26.xyz = (_LightColor0.xyz * max (0.000000, dot (lightDir_24, tmpvar_19)));
  ...
  tmpvar_32 = (res_26 * (atten_25 * 2.00000));
  res_26 = tmpvar_32;
  mediump vec4 c_33;
  c_33.xyz = ((tmpvar_3 * tmpvar_32.xyz) + (tmpvar_32.xyz * (tmpvar_32.w * tmpvar_4)));
  c_33.w = tmpvar_6;
  c_1.xyz = c_33.xyz;
  c_1.w = 0.000000;
  gl_FragData[0] = c_1;
...
void main ()
{
  ...
  tmpvar_25 = max (0.000000, dot (tmpvar_19, normalize((lightDir_21 + normalize(xlv_TEXCOORD2)))));
  nh_24 = tmpvar_25;
  mediump float arg1_26;
  arg1_26 = (tmpvar_5 * 128.000);
  res_23.xyz = (_LightColor0.xyz * max (0.000000, dot (lightDir_21, tmpvar_19)));
  lowp float tmpvar_27;
  tmpvar_27 = dot (_LightColor0.xyz, vec3(0.220000, 0.707000, 0.0710000));
  highp float tmpvar_28;
  tmpvar_28 = (pow (nh_24, arg1_26) * tmpvar_27);
  res_23.w = tmpvar_28;
  mediump vec4 tmpvar_29;
  tmpvar_29 = (res_23 * (atten_22 * 2.00000));
  res_23 = tmpvar_29;
  mediump vec4 c_30;
  c_30.xyz = ((tmpvar_3 * tmpvar_29.xyz) + (tmpvar_29.xyz * (tmpvar_29.w * tmpvar_4)));
  c_30.w = tmpvar_6;
  c_1.xyz = c_30.xyz;
  c_1.w = 0.000000;
  gl_FragData[0] = c_1;
...
Program "fp" {
// Fragment combos: 5
//   opengl - ALU: 47 to 57, TEX: 1 to 3
//   d3d9 - ALU: 60 to 68, TEX: 1 to 3
SubProgram "opengl " {
Keywords { "POINT" }
Vector 0 [_Time]
Vector 1 [_LightColor0]
...
MAD R0.w, R0.y, R1.x, R1.y;
ADD R0.y, -R0.z, c[8].x;
ADD R0.z, -R0.w, c[8].y;
MAD R0.y, R0.x, -c[7].x, R0;
...
def c10, 6.28318501, -3.14159298, 0.00000000, 128.00000000
def c11, 0.21997070, 0.70703125, 0.07098389, 2.00000000
dcl_texcoord0 v0.xy
dcl_texcoord1 v1.xyz
dcl_texcoord2 v2.xyz
dcl_texcoord3 v3.xyz
...
max_pp r2.x, r0, c10.z
pow r0, r2.x, r2.y
mov_pp r2.xyz, c1
dp3_pp r0.y, c11, r2
mul r3.x, r2.w, c4
mul r2.w, r0.x, r0.y
max_pp r0.y, r3.z, c10.z
dp3 r0.x, v3, v3
...
POW R0.x, R0.w, R2.x;
MUL R0.w, R0.x, R0.y;
MAX R0.x, fragment.texcoord[1].z, c[9];
MUL R2.x, R2.w, c[4];
MUL R0.xyz, R0.x, c[1];
MUL R0, R0, c[10].w;
MUL R2.xyz, R2.x, c[3];
...
mad r0.z, r1.x, r0.x, -r0.w
add r0.x, -r0.y, c8.y
mov r0.y, c7
mad r0.x, c0, -r0.y, r0
add r0.y, -r0.z, c8.x
mov r0.z, c7.x
mad r0.z, c0.x, -r0, r0.y
add r0.y, r0.x, c9.w
add r0.x, r0.z, c9.w
texld r0, r0, s0
add r1.x, -r0.w, c9.w
...
rsq_pp r2.x, r2.x
mov_pp r1.xyz, v1
mad_pp r1.xyz, r2.x, v2, r1
dp3_pp r1.x, r1, r1
rsq_pp r1.y, r1.x
mul_pp r1.y, r1, r1.z
mov_pp r1.x, c5
mul_pp r1.x, c10.w, r1
max_pp r1.y, r1, c10.z
pow r2, r1.y, r1.x
mul r0.w, r0, c4.x
mul r1.xyz, r0.w, c3
mov r0.w, r2.x
mov_pp r2.xyz, c1
dp3_pp r2.x, c11, r2
max_pp r2.w, v1.z, c10.z
mul_pp r2.yzw, r2.w, c1.xxyz
mul r2.x, r0.w, r2
mul_pp r2, r2.yzwx, c11.w
...
def c11, 128.00000000, 0.21997070, 0.70703125, 0.07098389
...
dp3_pp r1.x, v2, v2
rsq_pp r1.x, r1.x
mad_pp r1.xyz, r1.x, v2, r2
dp3_pp r0.x, r1, r1
mov_pp r0.y, c5.x
rsq_pp r0.x, r0.x
mul_pp r0.x, r0, r1.z
mul_pp r1.y, c11.x, r0
max_pp r1.x, r0, c10.z
mul r3.w, r0, c4.x
pow r0, r1.x, r1.y
mov_pp r1.xyz, c1
dp3_pp r0.y, c11.yzww, r1
mul r1.w, r0.x, r0.y
max_pp r0.y, r2.z, c10.z
mul_pp r1.xyz, r0.y, c1
rcp r0.x, v3.w
mad r2.xy, v3, r0.x, c9.z
texld r0.w, r2, s1
dp3 r0.x, v3, v3
cmp r0.y, -v3.z, c10.z, c10.w
mad r2.xyz, r2.w, r3, r2.w
mul_pp r0.y, r0, r0.w
texld r0.x, r0.x, s2
mul_pp r0.x, r0.y, r0
mul_pp r0, r0.x, r1
...
MUL R1.y, R0.z, R0.w;
MUL R1.z, R1.x, R0;
ADD R0.z, fragment.texcoord[0].x, -c[8].x;
MAD R0.w, R0.z, R0, R1.z;
MAD R0.z, R0, R1.x, -R1.y;
ADD R0.w, -R0, c[8].y;
MAD R0.w, R0.y, -c[7].y, R0;
ADD R0.z, -R0, c[8].x;
MAD R0.y, R0, -c[7].x, R0.z;
...
MUL R2.x, R2.w, c[4];
MUL R1.w, R1.x, R1.y;
MAX R1.x, fragment.texcoord[1].z, c[9];
MUL R1.xyz, R1.x, c[1];
...
mul_pp r1.x, r1, r1.z
mad r0.xyz, r0.w, r0, r0.w
mul_pp r2.y, c10.w, r1
max_pp r2.x, r1, c10.z
pow r1, r2.x, r2.y
mov r1.y, r1.x
mov_pp r2.xyz, c1
dp3_pp r1.x, c11, r2
...
void main ()
{
  ...
  tmpvar_5 = normalize(vec3(0.000000, 0.000000, 1.00000));
  highp float tmpvar_6;
  tmpvar_6 = dot (xlv_TEXCOORD0, tmpvar_5);
  worldN_2.x = tmpvar_6;
  ...
  tmpvar_9 = ((tmpvar_3 * 0.500000) + 0.500000);
  res_1.xyz = tmpvar_9;
  res_1.w = tmpvar_4;
  gl_FragData[0] = res_1;
}
...
void main ()
{
  ...
  tmpvar_18 = (mix (tmpvar_17, Tex2D0_9, tmpvar_17) * _MainColor);
  lowp vec4 tmpvar_19;
  tmpvar_19 = texture2D (_Emission, tmpvar_15.xy);
  Tex2D2_8 = tmpvar_19;
  highp vec3 tmpvar_20;
  tmpvar_20 = tmpvar_18.xyz;
  tmpvar_4 = tmpvar_20;
  highp vec3 tmpvar_21;
  tmpvar_21 = ((Tex2D2_8 * tmpvar_18) * _EmissionColor).xyz;
  tmpvar_5 = tmpvar_21;
  highp vec3 tmpvar_22;
  ...
  tmpvar_25 = -(log2(max (light_3, vec4(0.00100000, 0.00100000, 0.00100000, 0.00100000))));
  light_3.w = tmpvar_25.w;
  highp vec3 tmpvar_26;
  tmpvar_26 = (tmpvar_25.xyz + xlv_TEXCOORD2);
  light_3.xyz = tmpvar_26;
  mediump vec4 c_27;
  c_27.xyz = ((tmpvar_4 * light_3.xyz) + (light_3.xyz * (tmpvar_25.w * tmpvar_6)));
  c_27.w = tmpvar_7;
  c_2.w = c_27.w;
  c_2.xyz = (c_27.xyz + tmpvar_5);
  tmpvar_1 = c_2;
...
void main ()
{
  ...
  Tex2D2_10 = tmpvar_21;
  highp vec3 tmpvar_22;
  tmpvar_22 = tmpvar_20.xyz;
  tmpvar_6 = tmpvar_22;
  highp vec3 tmpvar_23;
  tmpvar_23 = ((Tex2D2_10 * tmpvar_20) * _EmissionColor).xyz;
  tmpvar_7 = tmpvar_23;
  highp vec3 tmpvar_24;
  tmpvar_24 = ((Tex2D0_11.wwww * vec4(_SpecularPower)) * _SpecularColor).xyz;
  tmpvar_8 = tmpvar_24;
  highp float tmpvar_25;
  tmpvar_25 = tmpvar_19.x;
  tmpvar_9 = tmpvar_25;
  lowp vec4 tmpvar_26;
  tmpvar_26 = texture2DProj (_LightBuffer, xlv_TEXCOORD1);
  light_5 = tmpvar_26;
  mediump vec4 tmpvar_27;
  tmpvar_27 = -(log2(max (light_5, vec4(0.00100000, 0.00100000, 0.00100000, 0.00100000))));
  light_5.w = tmpvar_27.w;
  lowp vec3 tmpvar_28;
  tmpvar_28 = (2.00000 * texture2D (unity_Lightmap, xlv_TEXCOORD2).xyz);
  lmFull_4 = tmpvar_28;
  lowp vec3 tmpvar_29;
  tmpvar_29 = (2.00000 * texture2D (unity_LightmapInd, xlv_TEXCOORD2).xyz);
  lmIndirect_3 = tmpvar_29;
  highp float tmpvar_30;
  tmpvar_30 = clamp (((sqrt(dot (xlv_TEXCOORD3, xlv_TEXCOORD3)) * unity_LightmapFade.z) + unity_LightmapFade.w), 0.000000, 1.00000);
  light_5.xyz = (tmpvar_27.xyz + mix (lmIndirect_3, lmFull_4, vec3(tmpvar_30)));
  mediump vec4 c_31;
  c_31.xyz = ((tmpvar_6 * light_5.xyz) + (light_5.xyz * (tmpvar_27.w * tmpvar_8)));
  c_31.w = tmpvar_9;
  c_2.w = c_31.w;
  c_2.xyz = (c_31.xyz + tmpvar_7);
  tmpvar_1 = c_2;
  gl_FragData[0] = tmpvar_1;
}
...
void main ()
{
  ...
  lowp vec3 tmpvar_29;
  tmpvar_29 = ((8.00000 * tmpvar_28.w) * tmpvar_28.xyz);
  lmFull_4 = tmpvar_29;
  lowp vec4 tmpvar_30;
  tmpvar_30 = texture2D (unity_LightmapInd, xlv_TEXCOORD2);
  lowp vec3 tmpvar_31;
  tmpvar_31 = ((8.00000 * tmpvar_30.w) * tmpvar_30.xyz);
  lmIndirect_3 = tmpvar_31;
  highp float tmpvar_32;
  tmpvar_32 = clamp (((sqrt(dot (xlv_TEXCOORD3, xlv_TEXCOORD3)) * unity_LightmapFade.z) + unity_LightmapFade.w), 0.000000, 1.00000);
  light_5.xyz = (tmpvar_27.xyz + mix (lmIndirect_3, lmFull_4, vec3(tmpvar_32)));
  mediump vec4 c_33;
  c_33.xyz = ((tmpvar_6 * light_5.xyz) + (light_5.xyz * (tmpvar_27.w * tmpvar_8)));
  c_33.w = tmpvar_9;
  c_2.w = c_33.w;
  c_2.xyz = (c_33.xyz + tmpvar_7);
  tmpvar_1 = c_2;
  gl_FragData[0] = tmpvar_1;
}
...
void main ()
{
  ...
  light_3 = tmpvar_24;
  mediump vec4 tmpvar_25;
  tmpvar_25 = max (light_3, vec4(0.00100000, 0.00100000, 0.00100000, 0.00100000));
  light_3.w = tmpvar_25.w;
  highp vec3 tmpvar_26;
  tmpvar_26 = (tmpvar_25.xyz + xlv_TEXCOORD2);
  light_3.xyz = tmpvar_26;
...
void main ()
{
  ...
  light_5 = tmpvar_26;
  mediump vec4 tmpvar_27;
  tmpvar_27 = max (light_5, vec4(0.00100000, 0.00100000, 0.00100000, 0.00100000));
  light_5.w = tmpvar_27.w;
  lowp vec3 tmpvar_28;
  tmpvar_28 = (2.00000 * texture2D (unity_Lightmap, xlv_TEXCOORD2).xyz);
  lmFull_4 = tmpvar_28;
