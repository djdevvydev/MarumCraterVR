Shader "Animated/Emission/Diffuse Normalmap Specular"
{
	Properties 
	{
...
void main ()
{
  ...
  Tex2D2_9 = tmpvar_21;
  lowp vec4 tmpvar_22;
  tmpvar_22 = texture2D (_Specular, tmpvar_17.xy);
  Tex2D1_8 = tmpvar_22;
  ...
  tmpvar_26 = ((Tex2D1_8 * vec4(_SpecularPower)) * _SpecularColor).xyz;
  tmpvar_5 = tmpvar_26;
...
void main ()
{
  ...
  Tex2D1_8 = tmpvar_23;
  highp vec3 tmpvar_24;
  tmpvar_24 = (mix (tmpvar_19, Tex2D0_11, tmpvar_19) * _MainColor).xyz;
  tmpvar_2 = tmpvar_24;
  highp vec3 tmpvar_25;
  tmpvar_25 = Tex2DNormal0_10.xyz;
  tmpvar_3 = tmpvar_25;
  highp vec3 tmpvar_26;
  tmpvar_26 = (Tex2D2_9 * _ColorEmission).xyz;
  tmpvar_4 = tmpvar_26;
  tmpvar_6 = _Gloss;
  highp vec3 tmpvar_27;
...
void main ()
{
  ...
  tmpvar_32 = texture2DProj (_ShadowMapTexture, xlv_TEXCOORD4).x;
  dist_31 = tmpvar_32;
  highp float tmpvar_33;
  tmpvar_33 = _LightShadowData.x;
  lightShadowDataX_30 = tmpvar_33;
  highp float tmpvar_34;
  tmpvar_34 = max (float((dist_31 > (xlv_TEXCOORD4.z / xlv_TEXCOORD4.w))), lightShadowDataX_30);
  tmpvar_29 = tmpvar_34;
  highp vec3 tmpvar_35;
  tmpvar_35 = normalize(xlv_TEXCOORD3);
  mediump vec3 lightDir_36;
  lightDir_36 = xlv_TEXCOORD1;
  ...
  tmpvar_41 = max (0.000000, dot (tmpvar_28, normalize((lightDir_36 + viewDir_37))));
  nh_40 = tmpvar_41;
  mediump float arg1_42;
  arg1_42 = (tmpvar_6 * 128.000);
  res_39.xyz = (_LightColor0.xyz * max (0.000000, dot (lightDir_36, tmpvar_28)));
  lowp float tmpvar_43;
  tmpvar_43 = dot (_LightColor0.xyz, vec3(0.220000, 0.707000, 0.0710000));
  highp float tmpvar_44;
  tmpvar_44 = (pow (nh_40, arg1_42) * tmpvar_43);
  res_39.w = tmpvar_44;
  mediump vec4 tmpvar_45;
  tmpvar_45 = (res_39 * (atten_38 * 2.00000));
  res_39 = tmpvar_45;
  mediump vec4 c_46;
  c_46.xyz = ((tmpvar_2 * tmpvar_45.xyz) + (tmpvar_45.xyz * (tmpvar_45.w * tmpvar_5)));
  c_46.w = tmpvar_7;
  c_1 = c_46;
  mediump vec3 tmpvar_47;
  tmpvar_47 = (c_1.xyz + (tmpvar_2 * xlv_TEXCOORD2));
  c_1.xyz = tmpvar_47;
  mediump vec3 tmpvar_48;
  tmpvar_48 = (c_1.xyz + tmpvar_4);
  c_1.xyz = tmpvar_48;
  gl_FragData[0] = c_1;
}
...
void main ()
{
  ...
  tmpvar_37 = max (0.000000, dot (tmpvar_29, normalize((lightDir_32 + viewDir_33))));
  nh_36 = tmpvar_37;
  mediump float arg1_38;
  arg1_38 = (tmpvar_6 * 128.000);
  res_35.xyz = (_LightColor0.xyz * max (0.000000, dot (lightDir_32, tmpvar_29)));
  ...
  res_35 = tmpvar_41;
  mediump vec4 c_42;
  c_42.xyz = ((tmpvar_2 * tmpvar_41.xyz) + (tmpvar_41.xyz * (tmpvar_41.w * tmpvar_5)));
  c_42.w = tmpvar_7;
  c_1 = c_42;
...
Program "fp" {
// Fragment combos: 4
//   opengl - ALU: 31 to 65, TEX: 3 to 5
//   d3d9 - ALU: 39 to 74, TEX: 3 to 5
SubProgram "opengl " {
Keywords { "DIRECTIONAL" "LIGHTMAP_OFF" "DIRLIGHTMAP_OFF" "SHADOWS_OFF" }
Vector 0 [_Time]
...
void main ()
{
  ...
  lowp vec4 tmpvar_22;
  tmpvar_22 = texture2D (_Emission, tmpvar_18.xy);
  Tex2D2_10 = tmpvar_22;
  lowp vec4 tmpvar_23;
  ...
  tmpvar_5 = tmpvar_25;
  highp vec3 tmpvar_26;
  tmpvar_26 = (Tex2D2_10 * _ColorEmission).xyz;
  tmpvar_6 = tmpvar_26;
  highp vec3 tmpvar_27;
  tmpvar_27 = ((Tex2D1_9 * vec4(_SpecularPower)) * _SpecularColor).xyz;
  tmpvar_7 = tmpvar_27;
  highp float tmpvar_28;
  tmpvar_28 = tmpvar_20.x;
  tmpvar_8 = tmpvar_28;
...
void main ()
{
  ...
  Tex2D1_9 = tmpvar_24;
  highp vec3 tmpvar_25;
  tmpvar_25 = (mix (tmpvar_20, Tex2D0_12, tmpvar_20) * _MainColor).xyz;
  tmpvar_4 = tmpvar_25;
  highp vec3 tmpvar_26;
  tmpvar_26 = Tex2DNormal0_11.xyz;
  tmpvar_5 = tmpvar_26;
  highp vec3 tmpvar_27;
  tmpvar_27 = (Tex2D2_10 * _ColorEmission).xyz;
  tmpvar_6 = tmpvar_27;
  highp vec3 tmpvar_28;
...
void main ()
{
  ...
  lowp vec4 tmpvar_23;
  tmpvar_23.w = 1.00000;
  tmpvar_23.xyz = ((texture2D (_Normalmap, tmpvar_20.xy).xyz * 2.00000) - 1.00000);
  Tex2DNormal0_13 = tmpvar_23;
  lowp vec4 tmpvar_24;
  tmpvar_24 = texture2D (_Emission, tmpvar_20.xy);
  Tex2D2_12 = tmpvar_24;
  lowp vec4 tmpvar_25;
  tmpvar_25 = texture2D (_Specular, tmpvar_20.xy);
  Tex2D1_11 = tmpvar_25;
  highp vec3 tmpvar_26;
  tmpvar_26 = (mix (tmpvar_22, Tex2D0_14, tmpvar_22) * _MainColor).xyz;
  tmpvar_6 = tmpvar_26;
  highp vec3 tmpvar_27;
  tmpvar_27 = Tex2DNormal0_13.xyz;
  tmpvar_7 = tmpvar_27;
  highp vec3 tmpvar_28;
  tmpvar_28 = (Tex2D2_12 * _ColorEmission).xyz;
  tmpvar_8 = tmpvar_28;
  highp vec3 tmpvar_29;
  tmpvar_29 = ((Tex2D1_11 * vec4(_SpecularPower)) * _SpecularColor).xyz;
  tmpvar_9 = tmpvar_29;
  highp float tmpvar_30;
  tmpvar_30 = tmpvar_22.x;
  tmpvar_10 = tmpvar_30;
  ...
  lowp vec3 tmpvar_33;
  tmpvar_33 = (2.00000 * texture2D (unity_Lightmap, xlv_TEXCOORD2).xyz);
  lmFull_4 = tmpvar_33;
  lowp vec3 tmpvar_34;
  tmpvar_34 = (2.00000 * texture2D (unity_LightmapInd, xlv_TEXCOORD2).xyz);
  lmIndirect_3 = tmpvar_34;
  highp float tmpvar_35;
  tmpvar_35 = clamp (((sqrt(dot (xlv_TEXCOORD3, xlv_TEXCOORD3)) * unity_LightmapFade.z) + unity_LightmapFade.w), 0.000000, 1.00000);
  light_5.xyz = (tmpvar_32.xyz + mix (lmIndirect_3, lmFull_4, vec3(tmpvar_35)));
  mediump vec4 c_36;
  c_36.xyz = ((tmpvar_6 * light_5.xyz) + (light_5.xyz * (tmpvar_32.w * tmpvar_9)));
  c_36.w = tmpvar_10;
  c_2.w = c_36.w;
  c_2.xyz = (c_36.xyz + tmpvar_8);
  tmpvar_1 = c_2;
  gl_FragData[0] = tmpvar_1;
}
...
void main ()
{
  ...
  tmpvar_22 = (vec4(1.00000, 1.00000, 1.00000, 1.00000) - ((vec4(1.00000, 1.00000, 1.00000, 1.00000) - Tex2D0_14.wwww) * vec4(_Alpha)));
  lowp vec3 normal_23;
  normal_23.xy = ((texture2D (_Normalmap, tmpvar_20.xy).wy * 2.00000) - 1.00000);
  ...
  Tex2D1_11 = tmpvar_26;
  highp vec3 tmpvar_27;
  tmpvar_27 = (mix (tmpvar_22, Tex2D0_14, tmpvar_22) * _MainColor).xyz;
  tmpvar_6 = tmpvar_27;
  highp vec3 tmpvar_28;
  tmpvar_28 = Tex2DNormal0_13.xyz;
  tmpvar_7 = tmpvar_28;
  highp vec3 tmpvar_29;
  tmpvar_29 = (Tex2D2_12 * _ColorEmission).xyz;
  tmpvar_8 = tmpvar_29;
  highp vec3 tmpvar_30;
  ...
  lowp vec3 tmpvar_37;
  tmpvar_37 = ((8.00000 * tmpvar_36.w) * tmpvar_36.xyz);
  lmIndirect_3 = tmpvar_37;
  highp float tmpvar_38;
  tmpvar_38 = clamp (((sqrt(dot (xlv_TEXCOORD3, xlv_TEXCOORD3)) * unity_LightmapFade.z) + unity_LightmapFade.w), 0.000000, 1.00000);
  light_5.xyz = (tmpvar_33.xyz + mix (lmIndirect_3, lmFull_4, vec3(tmpvar_38)));
  mediump vec4 c_39;
  c_39.xyz = ((tmpvar_6 * light_5.xyz) + (light_5.xyz * (tmpvar_33.w * tmpvar_9)));
  c_39.w = tmpvar_10;
  c_2.w = c_39.w;
  c_2.xyz = (c_39.xyz + tmpvar_8);
  tmpvar_1 = c_2;
  gl_FragData[0] = tmpvar_1;
}
...
Program "fp" {
// Fragment combos: 4
//   opengl - ALU: 36 to 51, TEX: 4 to 6
//   d3d9 - ALU: 43 to 56, TEX: 4 to 6
SubProgram "opengl " {
Keywords { "LIGHTMAP_OFF" "DIRLIGHTMAP_OFF" "HDR_LIGHT_PREPASS_OFF" }
Vector 0 [_Time]
Vector 1 [_MainColor]
...
COS R0.z, R0.y;
SIN R0.w, R0.y;
ADD R0.y, fragment.texcoord[0], -c[7];
MUL R2.x, R0.y, R0.w;
MUL R2.y, R0.z, R0;
ADD R0.y, fragment.texcoord[0].x, -c[7].x;
MAD R0.w, R0.y, R0, R2.y;
MAD R0.y, R0, R0.z, -R2.x;
ADD R0.z, -R0.w, c[7].y;
MAD R0.z, R0.x, -c[6].y, R0;
ADD R0.y, -R0, c[7].x;
