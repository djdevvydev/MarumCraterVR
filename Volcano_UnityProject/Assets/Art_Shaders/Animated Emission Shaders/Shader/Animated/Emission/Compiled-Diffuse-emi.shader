Shader "Animated/Emission/Diffuse"
{
	Properties 
	{
...
void main ()
{
  ...
  lowp vec4 tmpvar_17;
  tmpvar_17 = texture2D (_Emission, tmpvar_14.xy);
  Tex2D2_7 = tmpvar_17;
  highp vec3 tmpvar_18;
  tmpvar_18 = (mix (tmpvar_16, Tex2D0_8, tmpvar_16) * _MainColor).xyz;
  tmpvar_2 = tmpvar_18;
  highp vec3 tmpvar_19;
  tmpvar_19 = (Tex2D2_7 * _ColorEmission).xyz;
  tmpvar_3 = tmpvar_19;
  tmpvar_5 = _Gloss;
  highp vec3 tmpvar_20;
  tmpvar_20 = ((Tex2D0_8.wwww * vec4(_SpecularPower)) * _SpecularColor).xyz;
  tmpvar_4 = tmpvar_20;
  highp float tmpvar_21;
  tmpvar_21 = tmpvar_16.x;
  tmpvar_6 = tmpvar_21;
  mediump vec3 tmpvar_22;
  tmpvar_22 = normalize(vec3(0.000000, 0.000000, 1.00000));
  highp vec3 tmpvar_23;
  tmpvar_23 = normalize(xlv_TEXCOORD3);
  mediump vec3 lightDir_24;
  lightDir_24 = xlv_TEXCOORD1;
  mediump vec3 viewDir_25;
  viewDir_25 = tmpvar_23;
  mediump vec4 res_26;
  highp float nh_27;
  mediump float tmpvar_28;
  tmpvar_28 = max (0.000000, dot (tmpvar_22, normalize((lightDir_24 + viewDir_25))));
  nh_27 = tmpvar_28;
  mediump float arg1_29;
  arg1_29 = (tmpvar_5 * 128.000);
  res_26.xyz = (_LightColor0.xyz * max (0.000000, dot (lightDir_24, tmpvar_22)));
  ...
  res_26 = tmpvar_32;
  mediump vec4 c_33;
  c_33.xyz = ((tmpvar_2 * tmpvar_32.xyz) + (tmpvar_32.xyz * (tmpvar_32.w * tmpvar_4)));
  c_33.w = tmpvar_6;
  c_1 = c_33;
  mediump vec3 tmpvar_34;
  tmpvar_34 = (c_1.xyz + (tmpvar_2 * xlv_TEXCOORD2));
  c_1.xyz = tmpvar_34;
  mediump vec3 tmpvar_35;
  tmpvar_35 = (c_1.xyz + tmpvar_3);
  c_1.xyz = tmpvar_35;
  gl_FragData[0] = c_1;
}
...
void main ()
{
  ...
  lowp vec4 tmpvar_15;
  tmpvar_15 = texture2D (_Emission, tmpvar_12.xy);
  Tex2D2_5 = tmpvar_15;
  highp vec3 tmpvar_16;
  tmpvar_16 = (mix (tmpvar_14, Tex2D0_6, tmpvar_14) * _MainColor).xyz;
  tmpvar_2 = tmpvar_16;
  highp vec3 tmpvar_17;
  tmpvar_17 = (Tex2D2_5 * _ColorEmission).xyz;
  tmpvar_3 = tmpvar_17;
...
void main ()
{
  ...
  lowp vec3 tmpvar_20;
  tmpvar_20 = ((8.00000 * tmpvar_19.w) * tmpvar_19.xyz);
  mediump vec3 tmpvar_21;
...
void main ()
{
  ...
  tmpvar_35 = max (0.000000, dot (tmpvar_22, normalize((lightDir_30 + viewDir_31))));
  nh_34 = tmpvar_35;
  mediump float arg1_36;
  arg1_36 = (tmpvar_5 * 128.000);
  res_33.xyz = (_LightColor0.xyz * max (0.000000, dot (lightDir_30, tmpvar_22)));
  ...
  res_33 = tmpvar_39;
  mediump vec4 c_40;
  c_40.xyz = ((tmpvar_2 * tmpvar_39.xyz) + (tmpvar_39.xyz * (tmpvar_39.w * tmpvar_4)));
  c_40.w = tmpvar_6;
  c_1 = c_40;
...
void main ()
{
  ...
  tmpvar_30 = max (0.000000, dot (tmpvar_22, normalize((lightDir_25 + viewDir_26))));
  nh_29 = tmpvar_30;
  mediump float arg1_31;
  arg1_31 = (tmpvar_5 * 128.000);
  res_28.xyz = (_LightColor0.xyz * max (0.000000, dot (lightDir_25, tmpvar_22)));
...
void main ()
{
  ...
  tmpvar_4 = tmpvar_18;
  lowp vec4 tmpvar_19;
  tmpvar_19 = texture2DProj (_ShadowMapTexture, xlv_TEXCOORD2);
  lowp vec4 tmpvar_20;
  tmpvar_20 = texture2D (unity_Lightmap, xlv_TEXCOORD1);
  lowp vec3 tmpvar_21;
  tmpvar_21 = ((8.00000 * tmpvar_20.w) * tmpvar_20.xyz);
  lowp vec3 tmpvar_22;
  tmpvar_22 = max (min (tmpvar_21, ((tmpvar_19.x * 2.00000) * tmpvar_20.xyz)), (tmpvar_21 * tmpvar_19.x));
  mediump vec3 tmpvar_23;
  tmpvar_23 = (tmpvar_2 * tmpvar_22);
  c_1.xyz = tmpvar_23;
  c_1.w = tmpvar_4;
  mediump vec3 tmpvar_24;
  tmpvar_24 = (c_1.xyz + tmpvar_3);
  c_1.xyz = tmpvar_24;
  gl_FragData[0] = c_1;
}
...
Program "fp" {
// Fragment combos: 4
//   opengl - ALU: 31 to 53, TEX: 2 to 4
//   d3d9 - ALU: 39 to 64, TEX: 2 to 4
SubProgram "opengl " {
Keywords { "DIRECTIONAL" "LIGHTMAP_OFF" "DIRLIGHTMAP_OFF" "SHADOWS_OFF" }
Vector 0 [_Time]
...
POW R1.x, R1.w, R2.x;
MUL R1.w, R1.x, R1.y;
MAX R1.x, fragment.texcoord[1].z, c[10].z;
MUL R2.x, R2.w, c[4];
MUL R1.xyz, R1.x, c[1];
MUL R1, R1, c[11].w;
MUL R2.xyz, R2.x, c[3];
...
rsq_pp r0.x, r0.x
mul_pp r0.x, r0, r0.z
mul_pp r2.y, c11.w, r0
max_pp r2.x, r0, c11.z
pow r0, r2.x, r2.y
mul r0.y, r2.w, c4.x
mul r2.xyz, r0.y, c3
mov r0.w, r0.x
...
void main ()
{
  ...
  lowp vec4 tmpvar_18;
  tmpvar_18 = texture2D (_Emission, tmpvar_15.xy);
  Tex2D2_8 = tmpvar_18;
  highp vec3 tmpvar_19;
  tmpvar_19 = (mix (tmpvar_17, Tex2D0_9, tmpvar_17) * _MainColor).xyz;
  tmpvar_4 = tmpvar_19;
  highp vec3 tmpvar_20;
  tmpvar_20 = (Tex2D2_8 * _ColorEmission).xyz;
  tmpvar_5 = tmpvar_20;
  ...
  light_3 = tmpvar_23;
  mediump vec4 tmpvar_24;
  tmpvar_24 = -(log2(max (light_3, vec4(0.00100000, 0.00100000, 0.00100000, 0.00100000))));
  light_3.w = tmpvar_24.w;
  highp vec3 tmpvar_25;
  tmpvar_25 = (tmpvar_24.xyz + xlv_TEXCOORD2);
  light_3.xyz = tmpvar_25;
  mediump vec4 c_26;
  c_26.xyz = ((tmpvar_4 * light_3.xyz) + (light_3.xyz * (tmpvar_24.w * tmpvar_6)));
  c_26.w = tmpvar_7;
  c_2.w = c_26.w;
...
void main ()
{
  ...
  lowp vec4 tmpvar_20;
  tmpvar_20 = texture2D (_Emission, tmpvar_17.xy);
  Tex2D2_10 = tmpvar_20;
  highp vec3 tmpvar_21;
  tmpvar_21 = (mix (tmpvar_19, Tex2D0_11, tmpvar_19) * _MainColor).xyz;
  tmpvar_6 = tmpvar_21;
  highp vec3 tmpvar_22;
  tmpvar_22 = (Tex2D2_10 * _ColorEmission).xyz;
  tmpvar_7 = tmpvar_22;
  highp vec3 tmpvar_23;
  tmpvar_23 = ((Tex2D0_11.wwww * vec4(_SpecularPower)) * _SpecularColor).xyz;
  tmpvar_8 = tmpvar_23;
  highp float tmpvar_24;
  tmpvar_24 = tmpvar_19.x;
  tmpvar_9 = tmpvar_24;
  lowp vec4 tmpvar_25;
  tmpvar_25 = texture2DProj (_LightBuffer, xlv_TEXCOORD1);
  light_5 = tmpvar_25;
  mediump vec4 tmpvar_26;
  tmpvar_26 = -(log2(max (light_5, vec4(0.00100000, 0.00100000, 0.00100000, 0.00100000))));
  light_5.w = tmpvar_26.w;
  lowp vec3 tmpvar_27;
  tmpvar_27 = (2.00000 * texture2D (unity_Lightmap, xlv_TEXCOORD2).xyz);
  lmFull_4 = tmpvar_27;
  lowp vec3 tmpvar_28;
  tmpvar_28 = (2.00000 * texture2D (unity_LightmapInd, xlv_TEXCOORD2).xyz);
  lmIndirect_3 = tmpvar_28;
  highp float tmpvar_29;
  tmpvar_29 = clamp (((sqrt(dot (xlv_TEXCOORD3, xlv_TEXCOORD3)) * unity_LightmapFade.z) + unity_LightmapFade.w), 0.000000, 1.00000);
  light_5.xyz = (tmpvar_26.xyz + mix (lmIndirect_3, lmFull_4, vec3(tmpvar_29)));
  mediump vec4 c_30;
  c_30.xyz = ((tmpvar_6 * light_5.xyz) + (light_5.xyz * (tmpvar_26.w * tmpvar_8)));
  c_30.w = tmpvar_9;
  c_2.w = c_30.w;
  c_2.xyz = (c_30.xyz + tmpvar_7);
  tmpvar_1 = c_2;
  gl_FragData[0] = tmpvar_1;
}
...
void main ()
{
  ...
  lowp vec3 tmpvar_28;
  tmpvar_28 = ((8.00000 * tmpvar_27.w) * tmpvar_27.xyz);
  lmFull_4 = tmpvar_28;
  lowp vec4 tmpvar_29;
  tmpvar_29 = texture2D (unity_LightmapInd, xlv_TEXCOORD2);
  lowp vec3 tmpvar_30;
  tmpvar_30 = ((8.00000 * tmpvar_29.w) * tmpvar_29.xyz);
  ...
  light_5.xyz = (tmpvar_26.xyz + mix (lmIndirect_3, lmFull_4, vec3(tmpvar_31)));
  mediump vec4 c_32;
  c_32.xyz = ((tmpvar_6 * light_5.xyz) + (light_5.xyz * (tmpvar_26.w * tmpvar_8)));
  c_32.w = tmpvar_9;
  c_2.w = c_32.w;
  c_2.xyz = (c_32.xyz + tmpvar_7);
  tmpvar_1 = c_2;
  gl_FragData[0] = tmpvar_1;
}
...
void main ()
{
  ...
  light_3 = tmpvar_23;
  mediump vec4 tmpvar_24;
  tmpvar_24 = max (light_3, vec4(0.00100000, 0.00100000, 0.00100000, 0.00100000));
  light_3.w = tmpvar_24.w;
  highp vec3 tmpvar_25;
  tmpvar_25 = (tmpvar_24.xyz + xlv_TEXCOORD2);
  light_3.xyz = tmpvar_25;
...
void main ()
{
  ...
  light_5 = tmpvar_25;
  mediump vec4 tmpvar_26;
  tmpvar_26 = max (light_5, vec4(0.00100000, 0.00100000, 0.00100000, 0.00100000));
  light_5.w = tmpvar_26.w;
  lowp vec3 tmpvar_27;
  tmpvar_27 = (2.00000 * texture2D (unity_Lightmap, xlv_TEXCOORD2).xyz);
  lmFull_4 = tmpvar_27;
