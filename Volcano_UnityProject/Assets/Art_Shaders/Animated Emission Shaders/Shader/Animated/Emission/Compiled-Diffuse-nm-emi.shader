Shader "Animated/Emission/Diffuse Normalmap"
{
	Properties 
	{
...
_ColorEmission("Emission Color", Color) = (0.4980392,0.4980392,0.4980392,1)
...
uniform highp vec4 _ColorEmission;
...
void main ()
{
  ...
  lowp vec4 tmpvar_20;
  tmpvar_20 = texture2D (_Emission, tmpvar_16.xy);
  Tex2D2_8 = tmpvar_20;
  ...
  tmpvar_23 = (Tex2D2_8 * _ColorEmission).xyz;
  tmpvar_4 = tmpvar_23;
  tmpvar_6 = _Gloss;
  highp vec3 tmpvar_24;
  tmpvar_24 = ((Tex2D0_10.wwww * vec4(_SpecularPower)) * _SpecularColor).xyz;
  tmpvar_5 = tmpvar_24;
  highp float tmpvar_25;
  tmpvar_25 = tmpvar_18.x;
  tmpvar_7 = tmpvar_25;
  mediump vec3 tmpvar_26;
  tmpvar_26 = normalize(tmpvar_3);
  tmpvar_3 = tmpvar_26;
  highp vec3 tmpvar_27;
  ...
  tmpvar_32 = max (0.000000, dot (tmpvar_26, normalize((lightDir_28 + viewDir_29))));
  nh_31 = tmpvar_32;
  ...
  tmpvar_36 = (res_30 * 2.00000);
  res_30 = tmpvar_36;
  mediump vec4 c_37;
  c_37.xyz = ((tmpvar_2 * tmpvar_36.xyz) + (tmpvar_36.xyz * (tmpvar_36.w * tmpvar_5)));
  c_37.w = tmpvar_7;
  c_1 = c_37;
  mediump vec3 tmpvar_38;
  tmpvar_38 = (c_1.xyz + (tmpvar_2 * xlv_TEXCOORD2));
  c_1.xyz = tmpvar_38;
...
void main ()
{
  ...
  tmpvar_3 = tmpvar_23;
  highp vec3 tmpvar_24;
  tmpvar_24 = (Tex2D2_8 * _ColorEmission).xyz;
  tmpvar_4 = tmpvar_24;
  tmpvar_6 = _Gloss;
...
void main ()
{
  ...
  lowp vec4 tmpvar_17;
  tmpvar_17.w = 1.00000;
  tmpvar_17.xyz = ((texture2D (_Normalmap, tmpvar_14.xy).xyz * 2.00000) - 1.00000);
  Tex2DNormal0_7 = tmpvar_17;
  lowp vec4 tmpvar_18;
  tmpvar_18 = texture2D (_Emission, tmpvar_14.xy);
  Tex2D2_6 = tmpvar_18;
  highp vec3 tmpvar_19;
  tmpvar_19 = (mix (tmpvar_16, Tex2D0_8, tmpvar_16) * _MainColor).xyz;
  tmpvar_2 = tmpvar_19;
  highp vec3 tmpvar_20;
  tmpvar_20 = Tex2DNormal0_7.xyz;
  tmpvar_3 = tmpvar_20;
  highp vec3 tmpvar_21;
  tmpvar_21 = (Tex2D2_6 * _ColorEmission).xyz;
  tmpvar_4 = tmpvar_21;
  highp float tmpvar_22;
  tmpvar_22 = tmpvar_16.x;
  tmpvar_5 = tmpvar_22;
  tmpvar_3 = normalize(tmpvar_3);
  lowp vec3 tmpvar_23;
  tmpvar_23 = (2.00000 * texture2D (unity_Lightmap, xlv_TEXCOORD1).xyz);
  mediump vec3 tmpvar_24;
  tmpvar_24 = (tmpvar_2 * tmpvar_23);
  c_1.xyz = tmpvar_24;
  c_1.w = tmpvar_5;
  mediump vec3 tmpvar_25;
  tmpvar_25 = (c_1.xyz + tmpvar_4);
  c_1.xyz = tmpvar_25;
  gl_FragData[0] = c_1;
}
...
void main ()
{
  ...
  tmpvar_16 = (vec4(1.00000, 1.00000, 1.00000, 1.00000) - ((vec4(1.00000, 1.00000, 1.00000, 1.00000) - Tex2D0_8.wwww) * vec4(_Alpha)));
  lowp vec3 normal_17;
  normal_17.xy = ((texture2D (_Normalmap, tmpvar_14.xy).wy * 2.00000) - 1.00000);
  normal_17.z = sqrt(((1.00000 - (normal_17.x * normal_17.x)) - (normal_17.y * normal_17.y)));
  lowp vec4 tmpvar_18;
  tmpvar_18.w = 1.00000;
  ...
  Tex2D2_6 = tmpvar_19;
  highp vec3 tmpvar_20;
  tmpvar_20 = (mix (tmpvar_16, Tex2D0_8, tmpvar_16) * _MainColor).xyz;
  tmpvar_2 = tmpvar_20;
  highp vec3 tmpvar_21;
  tmpvar_21 = Tex2DNormal0_7.xyz;
  tmpvar_3 = tmpvar_21;
  highp vec3 tmpvar_22;
  tmpvar_22 = (Tex2D2_6 * _ColorEmission).xyz;
  tmpvar_4 = tmpvar_22;
  highp float tmpvar_23;
  ...
  tmpvar_3 = normalize(tmpvar_3);
  lowp vec4 tmpvar_24;
  tmpvar_24 = texture2D (unity_Lightmap, xlv_TEXCOORD1);
  lowp vec3 tmpvar_25;
  tmpvar_25 = ((8.00000 * tmpvar_24.w) * tmpvar_24.xyz);
  mediump vec3 tmpvar_26;
...
void main ()
{
  ...
  tmpvar_39 = max (0.000000, dot (tmpvar_26, normalize((lightDir_34 + viewDir_35))));
  nh_38 = tmpvar_39;
  mediump float arg1_40;
  arg1_40 = (tmpvar_6 * 128.000);
  res_37.xyz = (_LightColor0.xyz * max (0.000000, dot (lightDir_34, tmpvar_26)));
  lowp float tmpvar_41;
  tmpvar_41 = dot (_LightColor0.xyz, vec3(0.220000, 0.707000, 0.0710000));
  highp float tmpvar_42;
  tmpvar_42 = (pow (nh_38, arg1_40) * tmpvar_41);
  res_37.w = tmpvar_42;
  mediump vec4 tmpvar_43;
  tmpvar_43 = (res_37 * (atten_36 * 2.00000));
  res_37 = tmpvar_43;
  mediump vec4 c_44;
  c_44.xyz = ((tmpvar_2 * tmpvar_43.xyz) + (tmpvar_43.xyz * (tmpvar_43.w * tmpvar_5)));
  c_44.w = tmpvar_7;
  c_1 = c_44;
  mediump vec3 tmpvar_45;
  tmpvar_45 = (c_1.xyz + (tmpvar_2 * xlv_TEXCOORD2));
  c_1.xyz = tmpvar_45;
  mediump vec3 tmpvar_46;
  tmpvar_46 = (c_1.xyz + tmpvar_4);
  c_1.xyz = tmpvar_46;
  gl_FragData[0] = c_1;
}
...
void main ()
{
  ...
  tmpvar_35 = max (0.000000, dot (tmpvar_27, normalize((lightDir_30 + viewDir_31))));
  nh_34 = tmpvar_35;
  mediump float arg1_36;
  arg1_36 = (tmpvar_6 * 128.000);
  res_33.xyz = (_LightColor0.xyz * max (0.000000, dot (lightDir_30, tmpvar_27)));
  ...
  res_33 = tmpvar_39;
  mediump vec4 c_40;
  c_40.xyz = ((tmpvar_2 * tmpvar_39.xyz) + (tmpvar_39.xyz * (tmpvar_39.w * tmpvar_5)));
  c_40.w = tmpvar_7;
  c_1 = c_40;
  mediump vec3 tmpvar_41;
  tmpvar_41 = (c_1.xyz + (tmpvar_2 * xlv_TEXCOORD2));
  c_1.xyz = tmpvar_41;
  mediump vec3 tmpvar_42;
  tmpvar_42 = (c_1.xyz + tmpvar_4);
  c_1.xyz = tmpvar_42;
  gl_FragData[0] = c_1;
}
...
void main ()
{
  ...
  tmpvar_26 = texture2DProj (_ShadowMapTexture, xlv_TEXCOORD2).x;
  dist_25 = tmpvar_26;
  ...
  tmpvar_23 = tmpvar_28;
  lowp vec3 tmpvar_29;
  tmpvar_29 = min ((2.00000 * texture2D (unity_Lightmap, xlv_TEXCOORD1).xyz), vec3((tmpvar_23 * 2.00000)));
  mediump vec3 tmpvar_30;
  tmpvar_30 = (tmpvar_2 * tmpvar_29);
  c_1.xyz = tmpvar_30;
  c_1.w = tmpvar_5;
  mediump vec3 tmpvar_31;
  tmpvar_31 = (c_1.xyz + tmpvar_4);
  c_1.xyz = tmpvar_31;
  gl_FragData[0] = c_1;
}
...
void main ()
{
  ...
  tmpvar_3 = normalize(tmpvar_3);
  lowp vec4 tmpvar_24;
  tmpvar_24 = texture2DProj (_ShadowMapTexture, xlv_TEXCOORD2);
  lowp vec4 tmpvar_25;
  tmpvar_25 = texture2D (unity_Lightmap, xlv_TEXCOORD1);
  lowp vec3 tmpvar_26;
  tmpvar_26 = ((8.00000 * tmpvar_25.w) * tmpvar_25.xyz);
  lowp vec3 tmpvar_27;
  tmpvar_27 = max (min (tmpvar_26, ((tmpvar_24.x * 2.00000) * tmpvar_25.xyz)), (tmpvar_26 * tmpvar_24.x));
  mediump vec3 tmpvar_28;
  tmpvar_28 = (tmpvar_2 * tmpvar_27);
  c_1.xyz = tmpvar_28;
  c_1.w = tmpvar_5;
  mediump vec3 tmpvar_29;
  tmpvar_29 = (c_1.xyz + tmpvar_4);
  c_1.xyz = tmpvar_29;
  gl_FragData[0] = c_1;
}
...
Program "fp" {
// Fragment combos: 4
//   opengl - ALU: 31 to 64, TEX: 3 to 4
//   d3d9 - ALU: 39 to 74, TEX: 3 to 4
SubProgram "opengl " {
Keywords { "DIRECTIONAL" "LIGHTMAP_OFF" "DIRLIGHTMAP_OFF" "SHADOWS_OFF" }
Vector 0 [_Time]
...
DP3 R0.z, R1, fragment.texcoord[1];
MAX R0.x, R1.w, c[10].w;
POW R0.x, R0.x, R2.x;
MAX R1.x, R0.z, c[10].w;
MUL R1.w, R0.x, R0.y;
...
MUL R0.y, R0.x, R0.z;
ADD R1.y, fragment.texcoord[0].x, -c[5].x;
MAD R0.y, R1, R0.w, -R0;
MUL R0.x, R0.w, R0;
MAD R0.x, R1.y, R0.z, R0;
ADD R0.x, -R0, c[5].y;
MAD R0.x, R1, -c[4].y, R0;
ADD R0.y, -R0, c[5].x;
MAD R0.y, R1.x, -c[4].x, R0;
ADD R1.w, R0.x, c[6].y;
ADD R1.z, R0.y, c[6].y;
...
ADD R0.xyz, -R0.w, R0;
MAD R0.xyz, R0.w, R0, R0.w;
TXP R1.x, fragment.texcoord[2], texture[3], 2D;
...
MIN R3.xyz, R2, R3;
MUL R2.xyz, R2, R1.x;
TEX R1.xyz, R1.zwzw, texture[2], 2D;
MAX R2.xyz, R3, R2;
MUL R1.xyz, R1, c[3];
MUL R0.xyz, R0, c[1];
...
void main ()
{
  ...
  lowp vec4 tmpvar_20;
  tmpvar_20.w = 1.00000;
  tmpvar_20.xyz = ((texture2D (_Normalmap, tmpvar_17.xy).xyz * 2.00000) - 1.00000);
  Tex2DNormal0_10 = tmpvar_20;
  lowp vec4 tmpvar_21;
  tmpvar_21 = texture2D (_Emission, tmpvar_17.xy);
  Tex2D2_9 = tmpvar_21;
  highp vec3 tmpvar_22;
  tmpvar_22 = (mix (tmpvar_19, Tex2D0_11, tmpvar_19) * _MainColor).xyz;
  tmpvar_4 = tmpvar_22;
  highp vec3 tmpvar_23;
  tmpvar_23 = Tex2DNormal0_10.xyz;
  tmpvar_5 = tmpvar_23;
  highp vec3 tmpvar_24;
  tmpvar_24 = (Tex2D2_9 * _ColorEmission).xyz;
  tmpvar_6 = tmpvar_24;
  highp vec3 tmpvar_25;
  tmpvar_25 = ((Tex2D0_11.wwww * vec4(_SpecularPower)) * _SpecularColor).xyz;
  tmpvar_7 = tmpvar_25;
  highp float tmpvar_26;
  tmpvar_26 = tmpvar_19.x;
  tmpvar_8 = tmpvar_26;
  ...
  tmpvar_28 = -(log2(max (light_3, vec4(0.00100000, 0.00100000, 0.00100000, 0.00100000))));
  light_3.w = tmpvar_28.w;
  highp vec3 tmpvar_29;
  tmpvar_29 = (tmpvar_28.xyz + xlv_TEXCOORD2);
  light_3.xyz = tmpvar_29;
  mediump vec4 c_30;
  c_30.xyz = ((tmpvar_4 * light_3.xyz) + (light_3.xyz * (tmpvar_28.w * tmpvar_7)));
  c_30.w = tmpvar_8;
  c_2.w = c_30.w;
  c_2.xyz = (c_30.xyz + tmpvar_6);
  tmpvar_1 = c_2;
...
void main ()
{
  ...
  tmpvar_19 = (vec4(1.00000, 1.00000, 1.00000, 1.00000) - ((vec4(1.00000, 1.00000, 1.00000, 1.00000) - Tex2D0_11.wwww) * vec4(_Alpha)));
  lowp vec3 normal_20;
  normal_20.xy = ((texture2D (_Normalmap, tmpvar_17.xy).wy * 2.00000) - 1.00000);
  ...
  Tex2D2_9 = tmpvar_22;
  highp vec3 tmpvar_23;
  tmpvar_23 = (mix (tmpvar_19, Tex2D0_11, tmpvar_19) * _MainColor).xyz;
  tmpvar_4 = tmpvar_23;
  highp vec3 tmpvar_24;
  tmpvar_24 = Tex2DNormal0_10.xyz;
  tmpvar_5 = tmpvar_24;
  highp vec3 tmpvar_25;
  tmpvar_25 = (Tex2D2_9 * _ColorEmission).xyz;
  tmpvar_6 = tmpvar_25;
...
void main ()
{
  ...
  lowp vec4 tmpvar_22;
  tmpvar_22.w = 1.00000;
  tmpvar_22.xyz = ((texture2D (_Normalmap, tmpvar_19.xy).xyz * 2.00000) - 1.00000);
  Tex2DNormal0_12 = tmpvar_22;
  lowp vec4 tmpvar_23;
  tmpvar_23 = texture2D (_Emission, tmpvar_19.xy);
  Tex2D2_11 = tmpvar_23;
  highp vec3 tmpvar_24;
  tmpvar_24 = (mix (tmpvar_21, Tex2D0_13, tmpvar_21) * _MainColor).xyz;
  tmpvar_6 = tmpvar_24;
  highp vec3 tmpvar_25;
  tmpvar_25 = Tex2DNormal0_12.xyz;
  tmpvar_7 = tmpvar_25;
  highp vec3 tmpvar_26;
  tmpvar_26 = (Tex2D2_11 * _ColorEmission).xyz;
  tmpvar_8 = tmpvar_26;
  highp vec3 tmpvar_27;
  tmpvar_27 = ((Tex2D0_13.wwww * vec4(_SpecularPower)) * _SpecularColor).xyz;
  tmpvar_9 = tmpvar_27;
  highp float tmpvar_28;
  tmpvar_28 = tmpvar_21.x;
  tmpvar_10 = tmpvar_28;
  ...
  tmpvar_30 = -(log2(max (light_5, vec4(0.00100000, 0.00100000, 0.00100000, 0.00100000))));
  light_5.w = tmpvar_30.w;
  lowp vec3 tmpvar_31;
  tmpvar_31 = (2.00000 * texture2D (unity_Lightmap, xlv_TEXCOORD2).xyz);
  lmFull_4 = tmpvar_31;
  lowp vec3 tmpvar_32;
  tmpvar_32 = (2.00000 * texture2D (unity_LightmapInd, xlv_TEXCOORD2).xyz);
  lmIndirect_3 = tmpvar_32;
  highp float tmpvar_33;
  tmpvar_33 = clamp (((sqrt(dot (xlv_TEXCOORD3, xlv_TEXCOORD3)) * unity_LightmapFade.z) + unity_LightmapFade.w), 0.000000, 1.00000);
  light_5.xyz = (tmpvar_30.xyz + mix (lmIndirect_3, lmFull_4, vec3(tmpvar_33)));
  mediump vec4 c_34;
  c_34.xyz = ((tmpvar_6 * light_5.xyz) + (light_5.xyz * (tmpvar_30.w * tmpvar_9)));
  c_34.w = tmpvar_10;
  c_2.w = c_34.w;
  c_2.xyz = (c_34.xyz + tmpvar_8);
  tmpvar_1 = c_2;
  gl_FragData[0] = tmpvar_1;
}
...
void main ()
{
  ...
  tmpvar_21 = (vec4(1.00000, 1.00000, 1.00000, 1.00000) - ((vec4(1.00000, 1.00000, 1.00000, 1.00000) - Tex2D0_13.wwww) * vec4(_Alpha)));
  lowp vec3 normal_22;
  normal_22.xy = ((texture2D (_Normalmap, tmpvar_19.xy).wy * 2.00000) - 1.00000);
  normal_22.z = sqrt(((1.00000 - (normal_22.x * normal_22.x)) - (normal_22.y * normal_22.y)));
  lowp vec4 tmpvar_23;
  tmpvar_23.w = 1.00000;
  ...
  Tex2D2_11 = tmpvar_24;
  highp vec3 tmpvar_25;
  tmpvar_25 = (mix (tmpvar_21, Tex2D0_13, tmpvar_21) * _MainColor).xyz;
  tmpvar_6 = tmpvar_25;
  highp vec3 tmpvar_26;
  tmpvar_26 = Tex2DNormal0_12.xyz;
  tmpvar_7 = tmpvar_26;
  highp vec3 tmpvar_27;
  tmpvar_27 = (Tex2D2_11 * _ColorEmission).xyz;
  tmpvar_8 = tmpvar_27;
  highp vec3 tmpvar_28;
  ...
  lowp vec4 tmpvar_32;
  tmpvar_32 = texture2D (unity_Lightmap, xlv_TEXCOORD2);
  lowp vec3 tmpvar_33;
  tmpvar_33 = ((8.00000 * tmpvar_32.w) * tmpvar_32.xyz);
  lmFull_4 = tmpvar_33;
  lowp vec4 tmpvar_34;
  tmpvar_34 = texture2D (unity_LightmapInd, xlv_TEXCOORD2);
  lowp vec3 tmpvar_35;
  tmpvar_35 = ((8.00000 * tmpvar_34.w) * tmpvar_34.xyz);
  lmIndirect_3 = tmpvar_35;
  highp float tmpvar_36;
  tmpvar_36 = clamp (((sqrt(dot (xlv_TEXCOORD3, xlv_TEXCOORD3)) * unity_LightmapFade.z) + unity_LightmapFade.w), 0.000000, 1.00000);
  light_5.xyz = (tmpvar_31.xyz + mix (lmIndirect_3, lmFull_4, vec3(tmpvar_36)));
  mediump vec4 c_37;
  c_37.xyz = ((tmpvar_6 * light_5.xyz) + (light_5.xyz * (tmpvar_31.w * tmpvar_9)));
  c_37.w = tmpvar_10;
  c_2.w = c_37.w;
  c_2.xyz = (c_37.xyz + tmpvar_8);
  tmpvar_1 = c_2;
  gl_FragData[0] = tmpvar_1;
}
...
void main ()
{
  ...
  light_3 = tmpvar_27;
  mediump vec4 tmpvar_28;
  tmpvar_28 = max (light_3, vec4(0.00100000, 0.00100000, 0.00100000, 0.00100000));
  light_3.w = tmpvar_28.w;
  highp vec3 tmpvar_29;
  tmpvar_29 = (tmpvar_28.xyz + xlv_TEXCOORD2);
  light_3.xyz = tmpvar_29;
...
void main ()
{
  ...
  light_5 = tmpvar_29;
  mediump vec4 tmpvar_30;
  tmpvar_30 = max (light_5, vec4(0.00100000, 0.00100000, 0.00100000, 0.00100000));
  light_5.w = tmpvar_30.w;
  lowp vec3 tmpvar_31;
  tmpvar_31 = (2.00000 * texture2D (unity_Lightmap, xlv_TEXCOORD2).xyz);
  lmFull_4 = tmpvar_31;
...
Program "fp" {
// Fragment combos: 4
//   opengl - ALU: 35 to 50, TEX: 3 to 5
//   d3d9 - ALU: 43 to 56, TEX: 3 to 5
SubProgram "opengl " {
Keywords { "LIGHTMAP_OFF" "DIRLIGHTMAP_OFF" "HDR_LIGHT_PREPASS_OFF" }
Vector 0 [_Time]
Vector 1 [_MainColor]
...
TXP R1, fragment.texcoord[1], texture[3], 2D;
ADD R0.y, -R0.z, c[7];
MAD R0.y, R0.w, -c[6], R0;
ADD R0.x, -R0, c[7];
MAD R0.x, R0.w, -c[6], R0;
ADD R3.y, R0, c[9];
ADD R3.x, R0, c[9].y;
TEX R0, R3, texture[0], 2D;
TEX R3.xyz, R3, texture[2], 2D;
...
mad_pp r2.xyz, r0, c10.z, -r1
mov r0.w, c7.z
mul r0.w, c0.x, r0
add r0.w, r0, c9.x
mad r0.x, r0.w, c9.y, c9.z
frc r0.x, r0
dp4 r0.y, v3, v3
rsq r0.y, r0.y
